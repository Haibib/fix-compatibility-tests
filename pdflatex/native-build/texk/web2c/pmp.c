...
#include <math.h> 
#ifdef HAVE_UNISTD_H
#line 37 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
#  include <unistd.h>            
#endif
#line 39 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
...
xfree(mp->font_bc);
xfree(mp->font_ec);
#line 268 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
xfree(mp->font_id);
xfree(mp->font_nt);
xfree(mp->char_base);
xfree(mp->ctype_base);
...
#line 287 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
...
#line 67 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
{
...
#line 125 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
wterm(mp->banner);
wterm(" (");
wterm(getencstring());
wterm(")");
...
#line 343 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
/*:1297*/
#line 35741 "pmp.w"
;
}
...
#line 51 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
...
#else
#line 59 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
 if(f!=NULL)
fclose((FILE*)f);
#endif
#line 1222 "pmp.w"
...
#line 101 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
...
#line 164 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
/*:540*//*541:*/
#line 13233 "pmp.w"

case mp_text_node_type:
{
#line 190 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
...
number_add(mp_maxx,x1a);
#line 220 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
if(mp->font_id[mp_font_n(p)]!=tate_jfm_id){
...
{
#line 240 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
wlog(mp->banner);
wlog(" (");
wlog(getencstring());
wlog(")");
...
#line 277 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
...
#line 308 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
/*1298:*/
#line 343 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
...
{
#line 318 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
...
#else
#line 332 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
 cc= char_mp_info(f,mp_lookup_ctype(mp,f,fromBUFF(mp_text_p(p)->str,limit,k)));
k++;
#endif
#line 335 "../../../texlive-source/texk/web2c/pmpostdir/pmp.ch"
}else{
