...
zomegaprint ( strnumber s ) 
{
  ...
  if ( ( ommode == 0 ) || ( ( ommode == 1 ) && ( omtranslation == 0 ) ) ) 
  {
    ...
    while ( j < strstartar [s - 65535L ]) {
      ...
      news = strpool [j ];
      if ( ( news == neweqtbint ( 1049457L ) ) && ( selector < 20 ) ) 
      println () ;
      else if ( news < 32 ) 
      {
	printchar ( 94 ) ;
...
zprintcmdchr ( quarterword cmd , halfword chrcode ) 
{
  ...
  case 46 : 
    if ( chrcode == 0 ) 
    printesc ( 65819L ) ;
    else printesc ( 65821L ) ;
    break ;
  case 17 : 
    if ( chrcode == 0 ) 
    printesc ( 65820L ) ;
    else printesc ( 65822L ) ;
    break ;
  case 54 : 
    printesc ( 65823L ) ;
    break ;
  ...
  case 21 : 
    if ( chrcode == 1 ) 
    printesc ( 66414L ) ;
    else printesc ( 66415L ) ;
    break ;
  case 22 : 
    if ( chrcode == 1 ) 
    printesc ( 66416L ) ;
    else printesc ( 66417L ) ;
    break ;
  case 20 : 
    switch ( chrcode ) 
    {case 0 : 
  ...
  case 31 : 
    ...
    printesc ( 66425L ) ;
    else printesc ( 66422L ) ;
    break ;
  case 43 : 
    if ( chrcode == 0 ) 
    printesc ( 66442L ) ;
    else printesc ( 66441L ) ;
    break ;
  case 25 : 
    if ( chrcode == 10 ) 
    printesc ( 66453L ) ;
  ...
  case 69 : 
    if ( chrcode == 0 ) 
    printesc ( 66462L ) ;
    else printesc ( 66463L ) ;
    break ;
  case 48 : 
    if ( chrcode == 1 ) 
    printesc ( 66491L ) ;
    else printesc ( 66490L ) ;
    break ;
  case 50 : 
    switch ( chrcode ) 
    {case 16 : 
  ...
  case 88 : 
    ...
    printesc ( 65704L ) ;
    else if ( chrcode == 1115020L ) 
    printesc ( 65763L ) ;
    else printesc ( 66571L ) ;
    break ;
  case 89 : 
  ...
  case 105 : 
    if ( chrcode == 1 ) 
    printesc ( 66312L ) ;
    else printesc ( 66300L ) ;
    break ;
  case 81 : 
    if ( chrcode == 0 ) 
    printesc ( 66591L ) ;
    else printesc ( 66592L ) ;
    break ;
  case 90 : 
    {
      print ( 66604L ) ;
...
scanfilenamebraced ( void ) 
{
  ...
  oldsetting = selector ;
  selector = 21 ;
  showtokenlist ( mem [defref ].hh .v.RH , 0 , poolsize - poolptr ) ;
  selector = oldsetting ;
  s = makestring () ;
  ...
  stopatspace = false ;
  beginname () ;
  {register integer for_end; i = strstartar [s - 65536L ];for_end = 
  strstartar [s - 65535L ]- 1 ; if ( i <= for_end) do 
...
openlogfile ( void ) 
{
  ...
  logopened = true ;
  {
    ...
    fprintf ( logfile , "%s%s%c%s%c%s",  "This is Aleph, Version 3.141592653-" , "1.15" , '-' ,     "2.1" , '-' , "0.1" ) ;
    else
    fprintf ( logfile , "%s%s%c%s%c%s",  "This is Aleph, Version 3.141592653-" , "1.15" ,     '-' , "2.1" , '-' , "0.1" ) ;
    ...
    if ( ( neweqtbint ( 1049430L ) < 1 ) || ( neweqtbint ( 1049430L ) > 12 ) ) 
    fatalerror ( 66130L ) ;
...
zspecialout ( halfword p ) 
{
  ...
  selector = 21 ;
  showtokenlist ( mem [h ].hh .v.RH , 0 , poolsize - poolptr ) ;
  selector = oldsetting ;
  {
    if ( poolptr + 1 > poolsize ) 
    overflow ( 65543L , poolsize - initpoolptr ) ;
...
zoutwhat ( halfword p ) 
{
  ...
  case 2 : 
	...
	else if ( j < 16 ) 
	{
	  ...
	  [j ]) ) promptfilename ( 66697L , 66119L ) ;
	  writeopen [j ]= true ;
...
zshipout ( halfword p ) 
{
  ...
  if ( outputfilename == 0 ) 
  {
    ...
    openlogfile () ;
    packjobname ( 66123L ) ;
    while ( ! bopenout ( dvifile ) ) promptfilename ( 66124L , 66123L ) ;
...
{
  scanmode_regmem 
  if ( scankeyword ( 66818L ) ) 
  curval = 1 ;
  else if ( scankeyword ( 66819L ) ) 
  curval = 2 ;
  else if ( scankeyword ( 66820L ) ) 
  curval = 3 ;
  else if ( scankeyword ( 66821L ) ) 
  curval = 4 ;
  else {
