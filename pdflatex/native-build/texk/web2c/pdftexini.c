...
initialize ( void ) 
{
  ...
  if ( iniversion ) 
  {
    ...
    trieopptr = 0 ;
    trienotready = true ;
    hash [15514 ].v.RH = 1623 ;
    if ( iniversion ) 
    formatident = 1710 ;
    hash [15522 ].v.RH = 1933 ;
    eqtb [15522 ].hh.b1 = 1 ;
...
znewtrieop ( smallnumber d , smallnumber n , trieopcode v ) 
{
  ...
  while ( true ) {
    ...
    if ( l == 0 ) 
    {
      ...
      overflow ( 1376 , trieopsize ) ;
      u = trieused [curlang ];
      if ( u == maxtrieop ) 
      overflow ( 1377 , maxtrieop - mintrieop ) ;
      incr ( trieopptr ) ;
      incr ( u ) ;
      trieused [curlang ]= u ;
      if ( u > maxopused ) 
...
storefmtfile ( void ) 
{
  ...
  packjobname ( 951 ) ;
  while ( ! wopenout ( fmtfile ) ) promptfilename ( 1731 , 951 ) ;
  printnl ( 1732 ) ;
...
initprim ( void ) 
{
  ...
  primitive ( 575 , 74 , 29930 ) ;
  primitive ( 576 , 74 , 29931 ) ;
  primitive ( 577 , 74 , 29932 ) ;
  primitive ( 578 , 74 , 29933 ) ;
  primitive ( 579 , 74 , 29934 ) ;
  primitive ( 580 , 74 , 29935 ) ;
  primitive ( 581 , 74 , 29936 ) ;
  primitive ( 32 , 64 , 0 ) ;
  primitive ( 47 , 44 , 0 ) ;
  primitive ( 593 , 45 , 0 ) ;
  primitive ( 594 , 90 , 0 ) ;
  ...
  primitive ( 732 , 113 , 3 ) ;
  primitive ( 733 , 113 , 4 ) ;
  primitive ( 546 , 89 , membot + 0 ) ;
  primitive ( 583 , 89 , membot + 1 ) ;
  primitive ( 413 , 89 , membot + 2 ) ;
  primitive ( 414 , 89 , membot + 3 ) ;
  primitive ( 766 , 79 , 105 ) ;
  primitive ( 767 , 79 , 1 ) ;
  primitive ( 768 , 82 , 0 ) ;
  primitive ( 769 , 82 , 1 ) ;
  primitive ( 770 , 83 , 1 ) ;
  ...
  primitive ( 857 , 111 , 8 ) ;
  primitive ( 858 , 111 , 9 ) ;
  primitive ( 859 , 111 , 10 ) ;
  primitive ( 860 , 111 , 11 ) ;
  primitive ( 861 , 111 , 12 ) ;
  primitive ( 862 , 111 , 16 ) ;
  primitive ( 863 , 111 , 17 ) ;
  primitive ( 864 , 111 , 13 ) ;
  primitive ( 865 , 111 , 14 ) ;
  primitive ( 866 , 111 , 15 ) ;
  primitive ( 867 , 111 , 20 ) ;
  primitive ( 868 , 111 , 21 ) ;
  primitive ( 869 , 111 , 22 ) ;
  primitive ( 870 , 111 , 23 ) ;
  primitive ( 871 , 111 , 24 ) ;
  primitive ( 872 , 111 , 25 ) ;
  primitive ( 873 , 111 , 26 ) ;
  primitive ( 874 , 111 , 27 ) ;
  primitive ( 875 , 111 , 28 ) ;
  primitive ( 876 , 111 , 18 ) ;
  primitive ( 877 , 111 , 19 ) ;
  primitive ( 878 , 111 , 29 ) ;
  primitive ( 879 , 111 , 30 ) ;
  primitive ( 880 , 111 , 33 ) ;
  primitive ( 881 , 111 , 31 ) ;
  primitive ( 882 , 111 , 32 ) ;
  primitive ( 922 , 108 , 0 ) ;
  primitive ( 923 , 108 , 1 ) ;
  primitive ( 924 , 108 , 2 ) ;
  primitive ( 925 , 108 , 3 ) ;
  ...
  primitive ( 930 , 108 , 8 ) ;
  primitive ( 931 , 108 , 9 ) ;
  primitive ( 932 , 108 , 10 ) ;
  primitive ( 933 , 108 , 11 ) ;
  primitive ( 934 , 108 , 12 ) ;
  primitive ( 935 , 108 , 13 ) ;
  primitive ( 936 , 108 , 14 ) ;
  primitive ( 937 , 108 , 15 ) ;
  primitive ( 938 , 108 , 16 ) ;
  primitive ( 939 , 108 , 21 ) ;
  primitive ( 941 , 109 , 2 ) ;
  hash [15518 ].v.RH = 941 ;
  ...
  primitive ( 1321 , 4 , 256 ) ;
  primitive ( 1322 , 5 , 257 ) ;
  hash [15515 ].v.RH = 1322 ;
  eqtb [15515 ]= eqtb [curval ];
  primitive ( 1323 , 5 , 258 ) ;
  hash [15519 ].v.RH = 1324 ;
  hash [15520 ].v.RH = 1324 ;
  eqtb [15520 ].hh.b0 = 9 ;
  ...
  primitive ( 1485 , 20 , 4 ) ;
  primitive ( 1396 , 20 , 5 ) ;
  primitive ( 1486 , 20 , 109 ) ;
  primitive ( 1487 , 31 , 99 ) ;
  primitive ( 1488 , 31 , 100 ) ;
  primitive ( 1489 , 31 , 101 ) ;
  primitive ( 1490 , 31 , 102 ) ;
  primitive ( 1506 , 43 , 1 ) ;
  primitive ( 1507 , 43 , 0 ) ;
  primitive ( 1508 , 43 , 2 ) ;
  primitive ( 1518 , 25 , 12 ) ;
  primitive ( 1519 , 25 , 11 ) ;
  primitive ( 1520 , 25 , 10 ) ;
  primitive ( 1521 , 23 , 0 ) ;
  primitive ( 1522 , 23 , 1 ) ;
  primitive ( 1523 , 24 , 0 ) ;
  primitive ( 1524 , 24 , 1 ) ;
  ...
  primitive ( 1556 , 48 , 0 ) ;
  primitive ( 1557 , 48 , 1 ) ;
  primitive ( 1288 , 50 , 16 ) ;
  primitive ( 1289 , 50 , 17 ) ;
  primitive ( 1290 , 50 , 18 ) ;
  primitive ( 1291 , 50 , 19 ) ;
  primitive ( 1292 , 50 , 20 ) ;
  primitive ( 1293 , 50 , 21 ) ;
  primitive ( 1294 , 50 , 22 ) ;
  primitive ( 1295 , 50 , 23 ) ;
  primitive ( 1297 , 50 , 26 ) ;
  primitive ( 1296 , 50 , 27 ) ;
  primitive ( 1558 , 51 , 0 ) ;
  primitive ( 1301 , 51 , 1 ) ;
  primitive ( 1302 , 51 , 2 ) ;
  primitive ( 1283 , 53 , 0 ) ;
  ...
  primitive ( 1580 , 52 , 4 ) ;
  primitive ( 1581 , 52 , 5 ) ;
  primitive ( 1298 , 49 , 30 ) ;
  primitive ( 1299 , 49 , 31 ) ;
  hash [15517 ].v.RH = 1299 ;
  ...
  if ( enctexp ) 
  {
    primitive ( 1626 , 94 , 10 ) ;
    primitive ( 1627 , 94 , 11 ) ;
  } 
  primitive ( 1633 , 95 , 0 ) ;
  primitive ( 1634 , 95 , 1 ) ;
  primitive ( 1635 , 95 , 2 ) ;
  ...
  if ( enctexp ) 
  {
    primitive ( 1645 , 85 , 27690 ) ;
    primitive ( 1646 , 85 , 27691 ) ;
    primitive ( 1647 , 85 , 27692 ) ;
  } 
  primitive ( 440 , 85 , 28765 ) ;
  primitive ( 437 , 85 , 27997 ) ;
  primitive ( 438 , 85 , 28253 ) ;
  primitive ( 439 , 85 , 28509 ) ;
  primitive ( 547 , 85 , 29647 ) ;
  ...
  primitive ( 1670 , 78 , 8 ) ;
  primitive ( 1671 , 78 , 9 ) ;
  primitive ( 1672 , 78 , 10 ) ;
  primitive ( 1673 , 78 , 11 ) ;
  primitive ( 1674 , 78 , 6 ) ;
  primitive ( 274 , 100 , 0 ) ;
  primitive ( 275 , 100 , 1 ) ;
  primitive ( 276 , 100 , 2 ) ;
  primitive ( 1682 , 100 , 3 ) ;
  primitive ( 1683 , 60 , 1 ) ;
  primitive ( 1684 , 60 , 0 ) ;
  primitive ( 1685 , 58 , 0 ) ;
  primitive ( 1686 , 58 , 1 ) ;
  primitive ( 1692 , 57 , 27997 ) ;
  primitive ( 1693 , 57 , 28253 ) ;
  primitive ( 1694 , 19 , 0 ) ;
  primitive ( 1695 , 19 , 1 ) ;
  primitive ( 1696 , 19 , 2 ) ;
  primitive ( 1697 , 19 , 3 ) ;
  ...
  primitive ( 1745 , 59 , 2 ) ;
  primitive ( 1746 , 59 , 3 ) ;
  hash [15524 ].v.RH = 1746 ;
  eqtb [15524 ]= eqtb [curval ];
  primitive ( 1747 , 59 , 5 ) ;
  primitive ( 1748 , 59 , 6 ) ;
  primitive ( 1749 , 59 , 7 ) ;
  primitive ( 1145 , 59 , 40 ) ;
  primitive ( 1750 , 59 , 41 ) ;
  primitive ( 1751 , 59 , 42 ) ;
  primitive ( 1752 , 59 , 43 ) ;
  primitive ( 1753 , 59 , 9 ) ;
  primitive ( 1754 , 59 , 10 ) ;
  primitive ( 1755 , 59 , 11 ) ;
  primitive ( 1756 , 59 , 12 ) ;
  primitive ( 1757 , 59 , 13 ) ;
  primitive ( 1758 , 59 , 14 ) ;
  primitive ( 1759 , 59 , 15 ) ;
  primitive ( 1760 , 59 , 16 ) ;
  primitive ( 1761 , 59 , 17 ) ;
  primitive ( 1762 , 59 , 18 ) ;
  primitive ( 1763 , 59 , 19 ) ;
  primitive ( 1764 , 59 , 20 ) ;
  primitive ( 1765 , 59 , 21 ) ;
  primitive ( 1766 , 59 , 22 ) ;
  primitive ( 1767 , 59 , 23 ) ;
  primitive ( 1768 , 59 , 36 ) ;
  primitive ( 1769 , 59 , 37 ) ;
  primitive ( 1770 , 59 , 38 ) ;
  primitive ( 1771 , 59 , 24 ) ;
  primitive ( 1772 , 59 , 25 ) ;
  primitive ( 1773 , 59 , 26 ) ;
  primitive ( 1774 , 59 , 28 ) ;
  primitive ( 1775 , 59 , 27 ) ;
  primitive ( 1776 , 59 , 29 ) ;
  primitive ( 1777 , 59 , 30 ) ;
  primitive ( 1778 , 59 , 31 ) ;
  primitive ( 1779 , 59 , 32 ) ;
  primitive ( 1780 , 59 , 33 ) ;
  primitive ( 1781 , 59 , 35 ) ;
  primitive ( 1782 , 59 , 34 ) ;
  primitive ( 1783 , 59 , 39 ) ;
  primitive ( 1784 , 59 , 44 ) ;
  primitive ( 1785 , 59 , 45 ) ;
  primitive ( 1786 , 59 , 46 ) ;
  primitive ( 1787 , 59 , 47 ) ;
  primitive ( 1788 , 59 , 48 ) ;
  primitive ( 1789 , 59 , 49 ) ;
  primitive ( 1790 , 59 , 50 ) ;
  primitive ( 2104 , 73 , 29390 ) ;
  nonewcontrolsequence = true ;
} 
#endif /* INITEX */
void 
mainbody ( void ) 
{
  ...
  fprintf ( stdout , "%s%s%s",  "This is pdfTeX, Version 3.141592653" , "-2.6" , "-1.40.29"   ) ;
  else
  fprintf ( stdout , "%s%s%s",  "This is pdfTeX, Version 3.141592653" , "-2.6" ,   "-1.40.29" ) ;
  ...
  outputfilename = 0 ;
  {
    ...
    == 1710 ) ) 
    {
      nonewcontrolsequence = false ;
      primitive ( 1993 , 70 , 3 ) ;
      primitive ( 1994 , 70 , 20 ) ;
      primitive ( 883 , 111 , 5 ) ;
      primitive ( 1996 , 72 , 27172 ) ;
      primitive ( 1997 , 73 , 29379 ) ;
      primitive ( 1998 , 73 , 29380 ) ;
      primitive ( 1999 , 73 , 29381 ) ;
      primitive ( 2000 , 73 , 29382 ) ;
      primitive ( 2001 , 73 , 29383 ) ;
      primitive ( 2002 , 73 , 29384 ) ;
      primitive ( 2003 , 73 , 29385 ) ;
      primitive ( 2004 , 73 , 29386 ) ;
      primitive ( 2005 , 73 , 29387 ) ;
      primitive ( 2006 , 73 , 29388 ) ;
      primitive ( 2021 , 70 , 21 ) ;
      primitive ( 2022 , 70 , 22 ) ;
      primitive ( 2023 , 70 , 23 ) ;
      primitive ( 2024 , 70 , 24 ) ;
      primitive ( 2025 , 70 , 25 ) ;
      primitive ( 2026 , 70 , 28 ) ;
      primitive ( 2027 , 70 , 29 ) ;
      primitive ( 2028 , 70 , 30 ) ;
      primitive ( 2029 , 70 , 31 ) ;
      primitive ( 2030 , 70 , 32 ) ;
      primitive ( 2031 , 70 , 33 ) ;
      primitive ( 2032 , 70 , 34 ) ;
      primitive ( 2033 , 19 , 4 ) ;
      primitive ( 2035 , 19 , 5 ) ;
      primitive ( 2036 , 112 , 1 ) ;
      primitive ( 2037 , 112 , 5 ) ;
      primitive ( 2038 , 19 , 6 ) ;
      primitive ( 2042 , 82 , 2 ) ;
      primitive ( 1300 , 49 , 1 ) ;
      primitive ( 2046 , 73 , 29389 ) ;
      primitive ( 2047 , 33 , 6 ) ;
      primitive ( 2048 , 33 , 7 ) ;
      primitive ( 2049 , 33 , 10 ) ;
      primitive ( 2050 , 33 , 11 ) ;
      primitive ( 2059 , 107 , 2 ) ;
      primitive ( 2061 , 96 , 1 ) ;
      primitive ( 940 , 105 , 1 ) ;
      primitive ( 2062 , 108 , 17 ) ;
      primitive ( 2063 , 108 , 18 ) ;
      primitive ( 2064 , 108 , 19 ) ;
      primitive ( 2065 , 108 , 20 ) ;
      primitive ( 2066 , 108 , 22 ) ;
      primitive ( 2067 , 108 , 23 ) ;
      primitive ( 1615 , 93 , 8 ) ;
      primitive ( 2073 , 70 , 39 ) ;
      primitive ( 2074 , 70 , 40 ) ;
      primitive ( 2075 , 70 , 41 ) ;
      primitive ( 2076 , 70 , 42 ) ;
      primitive ( 2080 , 70 , 26 ) ;
      primitive ( 2081 , 70 , 27 ) ;
      primitive ( 2082 , 70 , 35 ) ;
      primitive ( 2083 , 70 , 36 ) ;
      primitive ( 2084 , 70 , 37 ) ;
      primitive ( 2085 , 70 , 38 ) ;
      primitive ( 2086 , 18 , 5 ) ;
      primitive ( 2087 , 113 , 5 ) ;
      primitive ( 2088 , 113 , 6 ) ;
      primitive ( 2089 , 113 , 7 ) ;
      primitive ( 2090 , 113 , 8 ) ;
      primitive ( 2091 , 113 , 9 ) ;
      primitive ( 2095 , 24 , 2 ) ;
      primitive ( 2096 , 24 , 3 ) ;
      primitive ( 2097 , 84 , 27429 ) ;
      primitive ( 2098 , 84 , 27430 ) ;
      primitive ( 2099 , 84 , 27431 ) ;
    ...
    magicoffset = strstart [1315 ]- 9 * 16 ;
    if ( interaction == 0 ) 
    selector = 16 ;
    else selector = 17 ;
