...
cstring 
zbibmakecstring ( strnumber s ) 
{
  register cstring Result; cstring cstr  ;
  poolpointer i  ;
  cstr = xmallocarray ( ASCIIcode , ( strstart [s + 1 ]- strstart [s ]) + 
  1 ) ;
  {register integer for_end; i = 0 ;for_end = ( strstart [s + 1 ]- 
  strstart [s ]) - 1 ; if ( i <= for_end) do 
    {
      cstr [i ]= strpool [strstart [s ]+ i ];
    } 
  while ( i++ < for_end ) ;} 
  cstr [( strstart [s + 1 ]- strstart [s ]) ]= 0 ;
  Result = cstr ;
  lab10: ;
  return Result ;
} 
...
boolean 
zstrendswith ( strnumber s , strnumber ext ) 
{
  register boolean Result; integer i  ;
  integer stridx, extidx  ;
  ASCIIcode strchar, extchar  ;
  Result = false ;
  if ( ( ( strstart [ext + 1 ]- strstart [ext ]) > ( strstart [s + 1 ]- 
  strstart [s ]) ) ) 
  goto lab10 ;
  stridx = ( strstart [s + 1 ]- strstart [s ]) - 1 ;
  extidx = ( strstart [ext + 1 ]- strstart [ext ]) - 1 ;
  while ( ( extidx >= 0 ) ) {
      
    strchar = strpool [strstart [s ]+ stridx ];
    extchar = strpool [strstart [ext ]+ extidx ];
    if ( ( strchar != extchar ) ) 
    goto lab10 ;
    stridx = stridx - 1 ;
    extidx = extidx - 1 ;
...
printbibname ( void ) 
{
  ...
  if ( ! strendswith ( biblist [bibptr ], sbibextension ) ) 
...
zlowercase ( buftype buf , bufpointer bfptr , bufpointer len ) 
{
  ...
  <= for_end) do 
    ...
    else if ( ( ( isinternalUPTEX () ) && ( buf [i ]>= 195 ) && ( buf [i ]
    <= 212 ) ) ) 
    {
      ch = fromBUFF ( buf , i + 2 , i ) ;
      if ( ( ( ( ch >= 192 ) && ( ch <= 222 ) && ( ch != 215 ) ) || ( ( ch >= 
      913 ) && ( ch <= 938 ) && ( ch != 930 ) ) || ( ( ch >= 1040 ) && ( ch <= 
      1071 ) ) ) ) 
      {
	ch = toBUFF ( ch + 32 ) ;
	buf [i ]= BYTE3 ( ch ) ;
	buf [i + 1 ]= BYTE4 ( ch ) ;
      ...
      else if ( ( ( ( ch >= 256 ) && ( ch <= 311 ) && ( ( ch % 2 ) == 0 ) ) || 
      ( ( ch >= 313 ) && ( ch <= 328 ) && ( ( ch % 2 ) == 1 ) ) || ( ( ch >= 
      330 ) && ( ch <= 375 ) && ( ( ch % 2 ) == 0 ) ) || ( ( ch >= 377 ) && ( 
      ch <= 382 ) && ( ( ch % 2 ) == 1 ) ) || ( ( ch >= 880 ) && ( ch <= 883 ) 
      && ( ( ch % 2 ) == 0 ) ) || ( ch == 886 ) || ( ( ch >= 984 ) && ( ch <= 
      1007 ) && ( ( ch % 2 ) == 0 ) ) || ( ch == 1015 ) || ( ch == 1018 ) || ( 
      ( ch >= 1120 ) && ( ch <= 1153 ) && ( ( ch % 2 ) == 0 ) ) || ( ( ch >= 
      1162 ) && ( ch <= 1215 ) && ( ( ch % 2 ) == 0 ) ) || ( ( ch >= 1217 ) && 
      ( ch <= 1230 ) && ( ( ch % 2 ) == 1 ) ) || ( ( ch >= 1232 ) && ( ch <= 
      1327 ) && ( ( ch % 2 ) == 0 ) ) ) ) 
      {
	ch = toBUFF ( ch + 1 ) ;
	buf [i ]= BYTE3 ( ch ) ;
...
zuppercase ( buftype buf , bufpointer bfptr , bufpointer len ) 
{
  ...
  <= for_end) do 
    ...
    {
      ch = fromBUFF ( buf , i + 2 , i ) ;
      if ( ( ( ( ch >= 224 ) && ( ch <= 254 ) && ( ch != 247 ) ) || ( ( ch >= 
      945 ) && ( ch <= 970 ) && ( ch != 962 ) ) || ( ( ch >= 1072 ) && ( ch <= 
      1103 ) ) ) ) 
      {
	ch = toBUFF ( ch - 32 ) ;
	buf [i ]= BYTE3 ( ch ) ;
	buf [i + 1 ]= BYTE4 ( ch ) ;
      ...
      else if ( ( ( ( ch >= 256 ) && ( ch <= 311 ) && ( ( ch % 2 ) == 1 ) ) || 
      ( ( ch >= 313 ) && ( ch <= 328 ) && ( ( ch % 2 ) == 0 ) ) || ( ( ch >= 
      330 ) && ( ch <= 375 ) && ( ( ch % 2 ) == 1 ) ) || ( ( ch >= 377 ) && ( 
      ch <= 382 ) && ( ( ch % 2 ) == 0 ) ) || ( ( ch >= 880 ) && ( ch <= 883 ) 
      && ( ( ch % 2 ) == 1 ) ) || ( ch == 887 ) || ( ( ch >= 984 ) && ( ch <= 
      1007 ) && ( ( ch % 2 ) == 1 ) ) || ( ch == 1016 ) || ( ch == 1019 ) || ( 
      ( ch >= 1120 ) && ( ch <= 1153 ) && ( ( ch % 2 ) == 1 ) ) || ( ( ch >= 
      1162 ) && ( ch <= 1215 ) && ( ( ch % 2 ) == 1 ) ) || ( ( ch >= 1217 ) && 
      ( ch <= 1230 ) && ( ( ch % 2 ) == 0 ) ) || ( ( ch >= 1232 ) && ( ch <= 
      1327 ) && ( ( ch % 2 ) == 1 ) ) ) ) 
      {
	ch = toBUFF ( ch - 1 ) ;
	buf [i ]= BYTE3 ( ch ) ;
...
boolean 
zischarkanjiupbibtex ( integer c ) 
{
...
compressbibwhite ( void ) 
{
  /* 10 */ register boolean Result; Result = false ;
  {
    ...
    {
      {
	fprintf ( logfile , "%s%ld%s",  "Field filled up at " , (long)32 , ", reallocating." ) ;
      } 
      {
	putc ('\n',  logfile );
      } 
...
scanbalancedbraces ( void ) 
{
  ...
  if ( ( storefield ) ) 
  {
	...
	bibbracelevel = bibbracelevel + 1 ;
	{
	  ...
	  {
	    {
	      fprintf ( logfile , "%s%ld%s",  "Field filled up at " , (long)123 ,               ", reallocating." ) ;
	    } 
	    {
	      putc ('\n',  logfile );
	    } 
	...
	} 
	{
	  ...
	  {case 125 : 
		...
		{
		  {
		    fprintf ( logfile , "%s%ld%s",  "Field filled up at " , (long)125 ,                     ", reallocating." ) ;
		  } 
		  {
		    putc ('\n',  logfile );
		  } 
	  ...
	  case 123 : 
		...
		{
		  {
		    fprintf ( logfile , "%s%ld%s",  "Field filled up at " , (long)buffer [bufptr2                     ], ", reallocating." ) ;
		  } 
		  {
		    putc ('\n',  logfile );
		  } 
  ...
  case 57 : 
	...
	while ( ( tmpptr < bufptr2 ) ) {
	    
	  {
	    ...
	    {
	      {
		fprintf ( logfile , "%s%ld%s",  "Field filled up at " , (long)buffer [tmpptr ],                 ", reallocating." ) ;
	      } 
	      {
		putc ('\n',  logfile );
	      } 
	...
	if ( ( storetoken ) ) 
	{
	  ...
	  while ( ( tmpptr < tmpendptr ) ) {
	    ...
	    if ( ( lexclass [strpool [tmpptr ]]!= 1 ) ) 
	    {
	      ...
	      {
		{
		  fprintf ( logfile , "%s%ld%s",  "Field filled up at " , (long)strpool [tmpptr ]                  , ", reallocating." ) ;
		} 
		{
		  putc ('\n',  logfile );
		} 
...
zaddoutpool ( strnumber pstr ) 
{
  ...
  while ( ( ( outbuflength > maxprintline ) && ( ! unbreakabletail ) ) ) {
    ...
    breakptfound = false ;
    while ( ( ( ( lexclass [outbuf [outbufptr ]]!= 1 ) || ( outbuf [
    outbufptr - 1 ]> 127 ) ) && ( outbufptr >= minprintline ) ) ) outbufptr = 
    outbufptr - 1 ;
    if ( ( outbufptr == minprintline - 1 ) ) 
    {
      outbufptr = maxprintline + 1 ;
      while ( ( outbufptr < endptr ) ) if ( ( lexclass [outbuf [outbufptr ]
      ]!= 1 ) || ( outbuf [outbufptr - 1 ]> 127 ) ) 
      outbufptr = outbufptr + 1 ;
      else goto lab16 ;
...
xchrtoint ( void ) 
{
  ...
  else if ( ( ( strstart [poplit1 + 1 ]- strstart [poplit1 ]) == 
  multibytelen ( strpool [strstart [poplit1 ]]) ) ) 
  {
    if ( ( ( strstart [poplit1 + 1 ]- strstart [poplit1 ]) == 1 ) ) 
    pushlitstk ( strpool [strstart [poplit1 ]], 0 ) ;
    else pushlitstk ( toDVI ( fromBUFF ( strpool , strstart [poplit1 ]+ ( 
    strstart [poplit1 + 1 ]- strstart [poplit1 ]) , strstart [poplit1 ]) 
    ) , 0 ) ;
  } 
  else {
...
xinttochr ( void ) 
{
  ...
  if ( ( poptyp1 != 0 ) ) 
  {
    ...
    if ( ( poplit1 > 127 ) ) 
    k = fromDVI ( poplit1 ) ;
    if ( ( ( poplit1 < 0 ) || ( ( poplit1 > 127 ) && ( k == 0 ) ) ) ) 
    {
      {
	{
	  fprintf ( logfile , "%ld%s",  (long)poplit1 , " isn't valid character code" ) ;
	  fprintf ( standardoutput , "%ld%s",  (long)poplit1 , " isn't valid character code" ) ;
	} 
	bstexwarnprint () ;
      } 
      pushlitstk ( snull , 1 ) ;
      ...
      {
	while ( ( poolptr + 4 > poolsize ) ) pooloverflow () ;
      } 
      k = toBUFF ( k ) ;
      if ( ( BYTE1 ( k ) > 0 ) ) 
      {
	strpool [poolptr ]= BYTE1 ( k ) ;
	poolptr = poolptr + 1 ;
      } 
      if ( ( BYTE2 ( k ) > 0 ) ) 
      {
	strpool [poolptr ]= BYTE2 ( k ) ;
	poolptr = poolptr + 1 ;
      } 
      if ( ( BYTE3 ( k ) > 0 ) ) 
      {
	strpool [poolptr ]= BYTE3 ( k ) ;
	poolptr = poolptr + 1 ;
      } 
      {
	strpool [poolptr ]= BYTE4 ( k ) ;
	poolptr = poolptr + 1 ;
      } 
      pushlitstk ( makestring () , 1 ) ;
    } 
...
xsubstring ( void ) 
{
  ...
  else if ( ( poptyp3 != 1 ) ) 
  {
	...
	if ( ( poplit2 == 1 ) ) {
	  ...
	  {
	    tpe = strstart [poplit3 ];
	    mbltpe = 0 ;
	    while ( tpe < strstart [poplit3 + 1 ]) {
		
	      mbltpe = multibytelen ( strpool [tpe ]) ;
	      if ( mbltpe < 0 || ( strstart [poplit3 + 1 ]< tpe + mbltpe ) ) 
	      break ;
	      tpe = tpe + mbltpe ;
	      if ( spend <= tpe ) 
	      break ;
	    } 
	    strstart [poplit3 + 1 ]= tpe ;
	    {
	      strptr = strptr + 1 ;
	      poolptr = strstart [strptr ];
	    } 
	...
	if ( multibytelen ( strpool [tpe ]) < 0 || ( strstart [poplit3 + 1 
	]< tpe + multibytelen ( strpool [tpe ]) ) ) 
	break ;
	mbltpe = multibytelen ( strpool [tpe ]) ;
	tpe = tpe + mbltpe ;
	if ( tpe <= spptr ) 
	...
	break ;
      ...
      if ( ( poplit2saved > 1 ) && ( tps == strstart [poplit3 ]) ) {
	  
	if ( multibytelen ( strpool [tps ]) >= 0 ) 
	tps = tps + multibytelen ( strpool [tps ]) ;
      } 
      if ( ( poplit2saved < -1 ) && ( tpe == strstart [poplit3 + 1 ]) ) 
      tpe = tpe - mbltpe ;
      if ( tps > tpe ) 
      tpe = tps ;
      spptr = tps ;
...
xiskanjistr ( void ) 
{
  ...
  if ( poptyp1 != 1 ) 
  {
    ...
    while ( spptr < spend ) {
      ...
      clen = multibytelen ( strpool [spptr ]) ;
      if ( spptr + clen <= spend ) 
      ctmp = fromBUFF ( strpool , spptr + clen , spptr ) ;
      else ctmp = strpool [spptr ];
      if ( ischarkanjiupbibtex ( ctmp ) ) 
      {
	pushlitstk ( 1 , 0 ) ;
	goto lab10 ;
      } 
...
auxinputcommand ( void ) 
{
  ...
  } 
  {
    ...
    } 
    {
      ...
      if ( ( ! kpseinnameok ( stringcast ( nameoffile + 1 ) ) || ( ! aopenin ( 
      auxfile [auxptr ], -1 ) && ! aopeninwithdirname ( auxfile [auxptr ], 
      -1 , bibmakecstring ( toplevstr ) ) ) ) ) 
      {
	{
...
setupparams ( void ) 
{
  ...
  kpsesetprogramname ( argv [0 ], "upbibtex" ) ;
...
#define noptions ( 9 ) 
  ...
  do {
    ...
    else if ( ( strcmp ( longoptions [optionindex ].name , "guess-input-enc" 
    ) == 0 ) ) 
    {
      enableguessfileenc () ;
    } 
    else if ( ( strcmp ( longoptions [optionindex ].name , 
    "no-guess-input-enc" ) == 0 ) ) 
    {
      disableguessfileenc () ;
    } 
...
void mainbody( void ) {
  ...
  {
    {
      Fputs ( logfile ,  "This is upBibTeX, Version 0.99e-j0.36-u2.02" ) ;
      Fputs ( standardoutput ,  "This is upBibTeX, Version 0.99e-j0.36-u2.02" ) 
      ;
    } 
    {
