...
initialize ( void ) 
{
  ...
  if ( iniversion ) 
  {
    ...
    trieopptr = 0 ;
    trienotready = true ;
    sethashtext ( 1442726L , 66557L ) ;
    if ( iniversion ) 
    formatident = 66633L ;
    sethashtext ( 1442734L , 66685L ) ;
    seteqlevel ( 196618L , 1 ) ;
    seteqtype ( 196618L , 130 ) ;
    setequiv ( 196618L , 0 ) ;
    eTeXmode = 0 ;
    maxregnum = 255 ;
    maxreghelpline = 66792L ;
  } 
#endif /* INITEX */
} 
#ifdef INITEX
...
znewtrieop ( smallnumber d , smallnumber n , quarterword v ) 
{
  ...
  while ( true ) {
    ...
    if ( l == 0 ) 
    {
      ...
      overflow ( 66308L , trieopsize ) ;
      u = trieused [curlang ];
      if ( u == 65535L ) 
      overflow ( 66309L , 65535L ) ;
      incr ( trieopptr ) ;
      incr ( u ) ;
      trieused [curlang ]= u ;
...
storefmtfile ( void ) 
{
  ...
  packjobname ( 66114L ) ;
  while ( ! wopenout ( fmtfile ) ) promptfilename ( 66652L , 66114L ) ;
  printnl ( 66653L ) ;
...
initprim ( void ) 
{
  ...
  parloc = curval ;
  partoken = 1048575L + parloc ;
  primitive ( 65939L , 121 , 0 ) ;
  primitive ( 65940L , 121 , 1 ) ;
  primitive ( 65941L , 127 , 0 ) ;
  primitive ( 65942L , 127 , 1 ) ;
  primitive ( 65943L , 127 , 2 ) ;
  primitive ( 65944L , 127 , 3 ) ;
  primitive ( 65945L , 127 , 4 ) ;
  primitive ( 65762L , 92 , membot + 0 ) ;
  primitive ( 65790L , 92 , membot + 1 ) ;
  primitive ( 65681L , 92 , membot + 2 ) ;
  primitive ( 65682L , 92 , membot + 3 ) ;
  primitive ( 65984L , 82 , 119 ) ;
  primitive ( 65985L , 82 , 1 ) ;
  primitive ( 65986L , 85 , 0 ) ;
  primitive ( 65987L , 85 , 1 ) ;
  primitive ( 65988L , 86 , 1 ) ;
  primitive ( 65989L , 86 , 3 ) ;
  primitive ( 65990L , 86 , 2 ) ;
  primitive ( 65991L , 73 , 0 ) ;
  primitive ( 65992L , 73 , 1 ) ;
  primitive ( 65993L , 73 , 2 ) ;
  primitive ( 65994L , 73 , 4 ) ;
  primitive ( 65995L , 73 , 5 ) ;
  primitive ( 66061L , 125 , 0 ) ;
  primitive ( 66062L , 125 , 1 ) ;
  primitive ( 66063L , 125 , 2 ) ;
  primitive ( 66064L , 125 , 3 ) ;
  primitive ( 66065L , 125 , 4 ) ;
  primitive ( 66066L , 125 , 5 ) ;
  primitive ( 66067L , 125 , 6 ) ;
  primitive ( 66068L , 125 , 7 ) ;
  primitive ( 66069L , 125 , 8 ) ;
  primitive ( 66086L , 122 , 0 ) ;
  primitive ( 66087L , 122 , 1 ) ;
  primitive ( 66088L , 122 , 2 ) ;
  primitive ( 66089L , 122 , 3 ) ;
  primitive ( 66090L , 122 , 4 ) ;
  primitive ( 66091L , 122 , 5 ) ;
  primitive ( 66092L , 122 , 6 ) ;
  primitive ( 66093L , 122 , 7 ) ;
  primitive ( 66094L , 122 , 8 ) ;
  primitive ( 66095L , 122 , 9 ) ;
  primitive ( 66096L , 122 , 10 ) ;
  primitive ( 66097L , 122 , 11 ) ;
  primitive ( 66098L , 122 , 12 ) ;
  primitive ( 66099L , 122 , 13 ) ;
  primitive ( 66100L , 122 , 14 ) ;
  primitive ( 66101L , 122 , 15 ) ;
  primitive ( 66102L , 122 , 16 ) ;
  primitive ( 65597L , 123 , 2 ) ;
  sethashtext ( 1442730L , 65597L ) ;
  setneweqtb ( 196614L , neweqtb ( curval ) ) ;
  primitive ( 66104L , 123 , 4 ) ;
  primitive ( 66105L , 123 , 3 ) ;
  primitive ( 66133L , 90 , 0 ) ;
  sethashtext ( 1442736L , 66133L ) ;
  setneweqtb ( 196620L , neweqtb ( curval ) ) ;
  primitive ( 66160L , 107 , 0 ) ;
  sethashtext ( 1508273L , 66160L ) ;
  setneweqtb ( 262157L , neweqtb ( curval ) ) ;
  geqdefine ( 524336L , 137 , 0 ) ;
  geqdefine ( 524337L , 137 , 0 ) ;
  geqdefine ( 524338L , 137 , 0 ) ;
  primitive ( 66174L , 109 , 0 ) ;
  sethashtext ( 1573809L , 66174L ) ;
  setneweqtb ( 327693L , neweqtb ( curval ) ) ;
  primitive ( 66257L , 4 , 65537L ) ;
  primitive ( 66258L , 5 , 65538L ) ;
  sethashtext ( 1442727L , 66258L ) ;
  setneweqtb ( 196611L , neweqtb ( curval ) ) ;
  primitive ( 66259L , 5 , 65539L ) ;
  sethashtext ( 1442731L , 66260L ) ;
  sethashtext ( 1442732L , 66260L ) ;
  seteqtype ( 196616L , 9 ) ;
  setequiv ( 196616L , memtop - 11 ) ;
  seteqlevel ( 196616L , 1 ) ;
  setneweqtb ( 196615L , neweqtb ( 196616L ) ) ;
  seteqtype ( 196615L , 132 ) ;
  primitive ( 66329L , 84 , 0 ) ;
  primitive ( 66330L , 84 , 1 ) ;
  primitive ( 66331L , 84 , 2 ) ;
  primitive ( 66332L , 84 , 3 ) ;
  primitive ( 66333L , 84 , 4 ) ;
  primitive ( 66334L , 84 , 5 ) ;
  primitive ( 66335L , 84 , 6 ) ;
  primitive ( 66336L , 84 , 7 ) ;
  primitive ( 66385L , 14 , 0 ) ;
  primitive ( 66386L , 14 , 1 ) ;
  primitive ( 66387L , 26 , 4 ) ;
  primitive ( 66388L , 26 , 0 ) ;
  primitive ( 66389L , 26 , 1 ) ;
  primitive ( 66390L , 26 , 2 ) ;
  primitive ( 66391L , 26 , 3 ) ;
  primitive ( 66392L , 27 , 4 ) ;
  primitive ( 66393L , 27 , 0 ) ;
  primitive ( 66394L , 27 , 1 ) ;
  primitive ( 66395L , 27 , 2 ) ;
  primitive ( 66396L , 27 , 3 ) ;
  primitive ( 65622L , 28 , 5 ) ;
  primitive ( 65626L , 29 , 1 ) ;
  primitive ( 65628L , 30 , 99 ) ;
  primitive ( 66414L , 21 , 1 ) ;
  primitive ( 66415L , 21 , 0 ) ;
  primitive ( 66416L , 22 , 1 ) ;
  primitive ( 66417L , 22 , 0 ) ;
  primitive ( 65695L , 20 , 0 ) ;
  primitive ( 66418L , 20 , 1 ) ;
  primitive ( 66419L , 20 , 2 ) ;
  primitive ( 66324L , 20 , 3 ) ;
  primitive ( 66420L , 20 , 4 ) ;
  primitive ( 66326L , 20 , 5 ) ;
  primitive ( 66421L , 20 , 123 ) ;
  primitive ( 66422L , 31 , 99 ) ;
  primitive ( 66423L , 31 , 100 ) ;
  primitive ( 66424L , 31 , 101 ) ;
  primitive ( 66425L , 31 , 102 ) ;
  primitive ( 66426L , 94 , 0 ) ;
  primitive ( 66441L , 43 , 1 ) ;
  primitive ( 66442L , 43 , 0 ) ;
  primitive ( 66451L , 25 , 12 ) ;
  primitive ( 66452L , 25 , 11 ) ;
  primitive ( 66453L , 25 , 10 ) ;
  primitive ( 66454L , 23 , 0 ) ;
  primitive ( 66455L , 23 , 1 ) ;
  primitive ( 66456L , 24 , 0 ) ;
  primitive ( 66457L , 24 , 1 ) ;
  primitive ( 45 , 47 , 1 ) ;
  primitive ( 65635L , 47 , 0 ) ;
  primitive ( 66462L , 69 , 0 ) ;
  primitive ( 66463L , 69 , 1 ) ;
  primitive ( 66490L , 48 , 0 ) ;
  primitive ( 66491L , 48 , 1 ) ;
  primitive ( 66224L , 50 , 16 ) ;
  primitive ( 66225L , 50 , 17 ) ;
  primitive ( 66226L , 50 , 18 ) ;
  primitive ( 66227L , 50 , 19 ) ;
  primitive ( 66228L , 50 , 20 ) ;
  primitive ( 66229L , 50 , 21 ) ;
  primitive ( 66230L , 50 , 22 ) ;
  primitive ( 66231L , 50 , 23 ) ;
  primitive ( 66233L , 50 , 26 ) ;
  primitive ( 66232L , 50 , 27 ) ;
  primitive ( 66492L , 51 , 0 ) ;
  primitive ( 66237L , 51 , 1 ) ;
  primitive ( 66238L , 51 , 2 ) ;
  primitive ( 66219L , 53 , 0 ) ;
  primitive ( 66220L , 53 , 2 ) ;
  primitive ( 66221L , 53 , 4 ) ;
  primitive ( 66222L , 53 , 6 ) ;
  primitive ( 66510L , 52 , 0 ) ;
  primitive ( 66511L , 52 , 1 ) ;
  primitive ( 66512L , 52 , 2 ) ;
  primitive ( 66513L , 52 , 3 ) ;
  primitive ( 66514L , 52 , 4 ) ;
  primitive ( 66515L , 52 , 5 ) ;
  primitive ( 66234L , 49 , 30 ) ;
  primitive ( 66235L , 49 , 31 ) ;
  sethashtext ( 1442729L , 66235L ) ;
  setneweqtb ( 196613L , neweqtb ( curval ) ) ;
  primitive ( 66535L , 99 , 1 ) ;
  primitive ( 66536L , 99 , 2 ) ;
  primitive ( 66537L , 99 , 4 ) ;
  primitive ( 66538L , 103 , 0 ) ;
  primitive ( 66539L , 103 , 1 ) ;
  primitive ( 66540L , 103 , 2 ) ;
  primitive ( 66541L , 103 , 3 ) ;
  primitive ( 66558L , 100 , 0 ) ;
  primitive ( 66559L , 100 , 1 ) ;
  primitive ( 66560L , 101 , 0 ) ;
  primitive ( 66561L , 101 , 1 ) ;
  primitive ( 66562L , 101 , 2 ) ;
  primitive ( 66563L , 101 , 3 ) ;
  primitive ( 66564L , 101 , 4 ) ;
  primitive ( 66565L , 101 , 5 ) ;
  primitive ( 66566L , 101 , 6 ) ;
  primitive ( 66567L , 101 , 7 ) ;
  primitive ( 65701L , 88 , 721728L ) ;
  primitive ( 65705L , 88 , 983872L ) ;
  primitive ( 66570L , 88 , 984128L ) ;
  primitive ( 65702L , 88 , 787264L ) ;
  primitive ( 65703L , 88 , 852800L ) ;
  primitive ( 65704L , 88 , 918336L ) ;
  primitive ( 65763L , 88 , 1115020L ) ;
  primitive ( 66571L , 88 , 1115276L ) ;
  primitive ( 65698L , 89 , 720960L ) ;
  primitive ( 65699L , 89 , 721216L ) ;
  primitive ( 65700L , 89 , 721472L ) ;
  primitive ( 66300L , 105 , 0 ) ;
  primitive ( 66312L , 105 , 1 ) ;
  primitive ( 66591L , 81 , 0 ) ;
  primitive ( 66592L , 81 , 1 ) ;
  primitive ( 65558L , 106 , 0 ) ;
  primitive ( 65559L , 106 , 1 ) ;
  primitive ( 65560L , 106 , 2 ) ;
  primitive ( 66605L , 106 , 3 ) ;
  primitive ( 66606L , 60 , 1 ) ;
  primitive ( 66607L , 60 , 0 ) ;
  primitive ( 66608L , 58 , 0 ) ;
  primitive ( 66609L , 58 , 1 ) ;
  primitive ( 66615L , 57 , 787264L ) ;
  primitive ( 66616L , 57 , 852800L ) ;
  primitive ( 66617L , 19 , 0 ) ;
  primitive ( 66618L , 19 , 1 ) ;
  primitive ( 66619L , 19 , 2 ) ;
  primitive ( 66620L , 19 , 3 ) ;
  primitive ( 66664L , 59 , 0 ) ;
  primitive ( 65903L , 59 , 1 ) ;
  writeloc = curval ;
  primitive ( 66665L , 59 , 2 ) ;
  primitive ( 66666L , 59 , 3 ) ;
  specialloc = curval ;
  specialtoken = 1048575L + specialloc ;
  primitive ( 66667L , 59 , 5 ) ;
  primitive ( 66668L , 59 , 6 ) ;
  primitive ( 66669L , 76 , 55 ) ;
  primitive ( 66670L , 76 , 56 ) ;
  primitive ( 66671L , 95 , 1049479L ) ;
  primitive ( 66672L , 95 , 1049480L ) ;
  primitive ( 66673L , 95 , 1049481L ) ;
  primitive ( 66674L , 95 , 1049482L ) ;
  primitive ( 66675L , 95 , 1049483L ) ;
  primitive ( 65786L , 77 , 1180578L ) ;
  primitive ( 65785L , 77 , 1180577L ) ;
  primitive ( 65787L , 77 , 1180579L ) ;
  primitive ( 65788L , 77 , 1180580L ) ;
  primitive ( 66801L , 116 , 0 ) ;
  primitive ( 66802L , 116 , 1 ) ;
  primitive ( 66803L , 116 , 2 ) ;
  primitive ( 66804L , 116 , 3 ) ;
  primitive ( 66805L , 116 , 4 ) ;
  primitive ( 66806L , 116 , 5 ) ;
  primitive ( 66807L , 116 , 6 ) ;
  primitive ( 66808L , 116 , 7 ) ;
  primitive ( 66809L , 117 , 0 ) ;
  primitive ( 66810L , 117 , 1 ) ;
  primitive ( 66811L , 117 , 2 ) ;
  primitive ( 66812L , 117 , 3 ) ;
  primitive ( 66813L , 117 , 4 ) ;
  primitive ( 66814L , 117 , 5 ) ;
  primitive ( 66815L , 117 , 6 ) ;
  primitive ( 66816L , 117 , 7 ) ;
  ...
  primitive ( 66829L , 108 , 0 ) ;
  primitive ( 66830L , 108 , 1 ) ;
  primitive ( 66831L , 110 , 0 ) ;
  primitive ( 66832L , 112 , 0 ) ;
  primitive ( 66833L , 113 , 0 ) ;
  primitive ( 66834L , 111 , 0 ) ;
  primitive ( 66835L , 114 , 1 ) ;
  primitive ( 66836L , 114 , 2 ) ;
  primitive ( 66837L , 114 , 3 ) ;
  primitive ( 66838L , 114 , 4 ) ;
  primitive ( 66839L , 115 , 0 ) ;
  setequiv ( 524335L , 0 ) ;
  nonewcontrolsequence = true ;
} 
#endif /* INITEX */
...
mainbody ( void ) 
{
  ...
  fprintf ( stdout , "%s%s%c%s%c%s",  "This is Aleph, Version 3.141592653-" , "1.15" , '-' ,   "2.1" , '-' , "0.1" ) ;
  else
  fprintf ( stdout , "%s%s%c%s%c%s",  "This is Aleph, Version 3.141592653-" , "1.15" , '-' ,   "2.1" , '-' , "0.1" ) ;
  ...
  outputfilename = 0 ;
  {
    ...
    {
      nonewcontrolsequence = false ;
      primitive ( 66702L , 73 , 3 ) ;
      primitive ( 66703L , 73 , 6 ) ;
      primitive ( 66704L , 73 , 7 ) ;
      primitive ( 66705L , 73 , 11 ) ;
      primitive ( 66706L , 73 , 8 ) ;
      primitive ( 66707L , 73 , 9 ) ;
      primitive ( 66708L , 73 , 10 ) ;
      primitive ( 66709L , 125 , 9 ) ;
      primitive ( 66710L , 125 , 10 ) ;
      primitive ( 66711L , 125 , 11 ) ;
      primitive ( 66713L , 75 , 524333L ) ;
      primitive ( 66714L , 76 , 1049469L ) ;
      primitive ( 66715L , 76 , 1049470L ) ;
      primitive ( 66716L , 76 , 1049471L ) ;
      primitive ( 66717L , 76 , 1049472L ) ;
      primitive ( 66718L , 76 , 1049473L ) ;
      primitive ( 66719L , 76 , 1049474L ) ;
      primitive ( 66720L , 76 , 1049475L ) ;
      primitive ( 66721L , 76 , 1049476L ) ;
      primitive ( 66722L , 76 , 1049477L ) ;
      primitive ( 66737L , 73 , 12 ) ;
      primitive ( 66738L , 73 , 13 ) ;
      primitive ( 66739L , 73 , 14 ) ;
      primitive ( 66740L , 73 , 15 ) ;
      primitive ( 66741L , 73 , 16 ) ;
      primitive ( 66742L , 73 , 19 ) ;
      primitive ( 66743L , 73 , 20 ) ;
      primitive ( 66744L , 73 , 21 ) ;
      primitive ( 66745L , 73 , 22 ) ;
      primitive ( 66746L , 73 , 23 ) ;
      primitive ( 66747L , 73 , 24 ) ;
      primitive ( 66748L , 73 , 25 ) ;
      primitive ( 66749L , 19 , 4 ) ;
      primitive ( 66751L , 19 , 5 ) ;
      primitive ( 66752L , 126 , 1 ) ;
      primitive ( 66753L , 126 , 5 ) ;
      primitive ( 66754L , 19 , 6 ) ;
      primitive ( 66758L , 85 , 2 ) ;
      primitive ( 66236L , 49 , 1 ) ;
      primitive ( 66762L , 121 , 2 ) ;
      primitive ( 66764L , 102 , 1 ) ;
      primitive ( 66103L , 119 , 1 ) ;
      primitive ( 66765L , 122 , 17 ) ;
      primitive ( 66766L , 122 , 18 ) ;
      primitive ( 66767L , 122 , 19 ) ;
      primitive ( 66549L , 99 , 8 ) ;
      primitive ( 66773L , 73 , 30 ) ;
      primitive ( 66774L , 73 , 31 ) ;
      primitive ( 66775L , 73 , 32 ) ;
      primitive ( 66776L , 73 , 33 ) ;
      primitive ( 66780L , 73 , 17 ) ;
      primitive ( 66781L , 73 , 18 ) ;
      primitive ( 66782L , 73 , 26 ) ;
      primitive ( 66783L , 73 , 27 ) ;
      primitive ( 66784L , 73 , 28 ) ;
      primitive ( 66785L , 73 , 29 ) ;
      primitive ( 66786L , 18 , 5 ) ;
      primitive ( 66787L , 127 , 5 ) ;
      primitive ( 66788L , 127 , 6 ) ;
      primitive ( 66789L , 127 , 7 ) ;
      primitive ( 66790L , 127 , 8 ) ;
      primitive ( 66791L , 127 , 9 ) ;
      primitive ( 66795L , 24 , 2 ) ;
      primitive ( 66796L , 24 , 3 ) ;
      primitive ( 66797L , 87 , 524321L ) ;
      primitive ( 66798L , 87 , 524322L ) ;
      primitive ( 66799L , 87 , 524323L ) ;
      primitive ( 66800L , 87 , 524324L ) ;
...
#endif /* INITEX */
    magicoffset = strstartar [715 ]- 9 * 16 ;
    if ( interaction == 0 ) 
    selector = 16 ;
    else selector = 17 ;
