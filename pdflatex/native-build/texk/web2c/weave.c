...
#define noptions ( 4 ) 
  ...
  longoptions [currentoption ].val = 0 ;
  currentoption = currentoption + 1 ;
  longoptions [currentoption ].name = chartostring ( 'p' ) ;
  longoptions [currentoption ].hasarg = 0 ;
  longoptions [currentoption ].flag = addressof ( pdfoutput ) ;
  ...
  do {
    ...
    {
      printversionandexit ( "This is WEAVE, Version 4.5" , nil , "D.E. Knuth" 
      , nil ) ;
    } 
  } while ( ! ( getoptreturnval == -1 ) ) ;
  if ( ( optind + 1 > argc ) || ( optind + 3 < argc ) ) 
  {
    fprintf ( stderr , "%s%s\n",  "weave" , ": Need one to three file arguments." ) ;
    usage ( "weave" ) ;
  } 
...
void mainbody( void ) {
  ...
  initialize () ;
  Fputs ( stdout ,  "This is WEAVE, Version 4.5" ) ;
  fprintf ( stdout , "%s\n",  versionstring ) ;
  idloc = 10 ;
  idfirst = 7 ;
  buffer [7 ]= 97 ;
