...
static const char *poolfilearr[] = {
  ...
  "A character number must be between 0 and \"2E7F.",
  ...
  "), should be in the ranges 1..4, 6..8, 10..13, 16..20",
  "), should be in the ranges 16..20",
  "I'm going to use 18 instead of that illegal code value.",
  " at ",
  ...
  " in font ",
  "Character ",
  ") cannot be typeset in JIS-encoded JFM ",
  ...
  "xleaders",
  "Improper `",
  "You cannot change the direction in unrestricted",
  "horizontal mode.",
  "You cannot change the direction in math mode.",
  "Use `",
  "' at top of list",
  ...
  "\\discretionary's argument and outer hlist must have same direction.",
  ...
  " = `",
  "Unknown encoding `",
  "Warning: \\epTeXinputencoding is ignored, since I am current reading",
  "from ",
  "a pseudo file created by \\scantokens.",
  "input stream ",
  "lastnodetype",
  "lastnodesubtype",
  "lastnodechar",
  ...
  "TFM encoding specification is ignored.",
  ...
  " direction",
  "' at top of the page",
  "You can change the direction of the page only when",
