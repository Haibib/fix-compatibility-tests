...
const{27:}triesize=10000000;triecsize=5000000;maxops=4080;maxval=10;
...
' missed');
if(goodcount+misscount)>0 then begin printreal((100*(goodcount/(
goodcount+misscount))),1,2);write(output,' %, ');
