...
znewtrieop ( smallnumber d , smallnumber n , trieopcode v ) 
{
  ...
  while ( true ) {
    ...
    if ( l == 0 ) 
    {
      ...
      overflow ( 66385L , trieopsize ) ;
      u = trieused [curlang ];
      if ( u == maxtrieop ) 
      overflow ( 66386L , maxtrieop - mintrieop ) ;
      incr ( trieopptr ) ;
      incr ( u ) ;
      trieused [curlang ]= u ;
      if ( u > maxopused ) 
...
storefmtfile ( void ) 
{
  ...
  packjobname ( 66175L ) ;
  while ( ! wopenout ( fmtfile ) ) promptfilename ( 66736L , 66175L ) ;
  printnl ( 66737L ) ;
...
initprim ( void ) 
{
  ...
  first = 0 ;
  primitive ( 65675L , 76 , 1205764L ) ;
  primitive ( 65676L , 76 , 1205765L ) ;
  primitive ( 65677L , 76 , 1205766L ) ;
  primitive ( 65678L , 76 , 1205767L ) ;
  primitive ( 65679L , 76 , 1205768L ) ;
  primitive ( 65680L , 76 , 1205769L ) ;
  primitive ( 65681L , 76 , 1205770L ) ;
  primitive ( 65682L , 76 , 1205771L ) ;
  primitive ( 65683L , 76 , 1205772L ) ;
  primitive ( 65684L , 76 , 1205773L ) ;
  primitive ( 65685L , 76 , 1205774L ) ;
  primitive ( 65686L , 76 , 1205775L ) ;
  primitive ( 65687L , 76 , 1205776L ) ;
  primitive ( 65688L , 76 , 1205777L ) ;
  primitive ( 65689L , 76 , 1205778L ) ;
  primitive ( 65690L , 76 , 1205779L ) ;
  primitive ( 65691L , 77 , 1205780L ) ;
  primitive ( 65692L , 77 , 1205781L ) ;
  primitive ( 65693L , 77 , 1205782L ) ;
  primitive ( 65698L , 73 , 1206296L ) ;
  primitive ( 65699L , 73 , 1206297L ) ;
  primitive ( 65700L , 73 , 1206298L ) ;
  primitive ( 65701L , 73 , 1206299L ) ;
  primitive ( 65702L , 73 , 1206300L ) ;
  primitive ( 65703L , 73 , 1206301L ) ;
  primitive ( 65704L , 73 , 1206302L ) ;
  primitive ( 65705L , 73 , 1206303L ) ;
  primitive ( 65706L , 73 , 1206304L ) ;
  primitive ( 65720L , 74 , 7892264L ) ;
  primitive ( 65721L , 74 , 7892265L ) ;
  primitive ( 65722L , 74 , 7892266L ) ;
  primitive ( 65723L , 74 , 7892267L ) ;
  primitive ( 65724L , 74 , 7892268L ) ;
  primitive ( 65725L , 74 , 7892269L ) ;
  primitive ( 65726L , 74 , 7892270L ) ;
  primitive ( 65727L , 74 , 7892271L ) ;
  primitive ( 65728L , 74 , 7892272L ) ;
  primitive ( 65729L , 74 , 7892273L ) ;
  primitive ( 65730L , 74 , 7892274L ) ;
  primitive ( 65731L , 74 , 7892275L ) ;
  primitive ( 65732L , 74 , 7892276L ) ;
  primitive ( 65733L , 74 , 7892277L ) ;
  primitive ( 65734L , 74 , 7892278L ) ;
  primitive ( 65735L , 74 , 7892279L ) ;
  primitive ( 65736L , 74 , 7892280L ) ;
  primitive ( 65737L , 74 , 7892281L ) ;
  primitive ( 65738L , 74 , 7892282L ) ;
  primitive ( 65739L , 74 , 7892283L ) ;
  primitive ( 65740L , 74 , 7892284L ) ;
  primitive ( 65741L , 74 , 7892285L ) ;
  primitive ( 65742L , 74 , 7892286L ) ;
  primitive ( 65743L , 74 , 7892287L ) ;
  primitive ( 65744L , 74 , 7892288L ) ;
  primitive ( 65745L , 74 , 7892289L ) ;
  primitive ( 65746L , 74 , 7892290L ) ;
  primitive ( 65747L , 74 , 7892291L ) ;
  primitive ( 65748L , 74 , 7892292L ) ;
  primitive ( 65749L , 74 , 7892293L ) ;
  primitive ( 65750L , 74 , 7892294L ) ;
  primitive ( 65751L , 74 , 7892295L ) ;
  primitive ( 65752L , 74 , 7892296L ) ;
  primitive ( 65753L , 74 , 7892297L ) ;
  primitive ( 65754L , 74 , 7892298L ) ;
  primitive ( 65755L , 74 , 7892299L ) ;
  primitive ( 65756L , 74 , 7892300L ) ;
  primitive ( 65757L , 74 , 7892301L ) ;
  primitive ( 65758L , 74 , 7892302L ) ;
  primitive ( 65759L , 74 , 7892303L ) ;
  primitive ( 65760L , 74 , 7892304L ) ;
  primitive ( 65761L , 74 , 7892305L ) ;
  primitive ( 65762L , 74 , 7892306L ) ;
  primitive ( 65763L , 74 , 7892307L ) ;
  primitive ( 65764L , 74 , 7892308L ) ;
  primitive ( 65765L , 74 , 7892309L ) ;
  primitive ( 65766L , 74 , 7892310L ) ;
  primitive ( 65767L , 74 , 7892311L ) ;
  primitive ( 65768L , 74 , 7892312L ) ;
  primitive ( 65769L , 74 , 7892313L ) ;
  primitive ( 65770L , 74 , 7892314L ) ;
  primitive ( 65771L , 74 , 7892315L ) ;
  primitive ( 65772L , 74 , 7892316L ) ;
  primitive ( 65773L , 74 , 7892317L ) ;
  primitive ( 65774L , 74 , 7892318L ) ;
  if ( mltexp ) 
  {
    mltexenabledp = true ;
    if ( false ) 
    primitive ( 65775L , 74 , 7892319L ) ;
    primitive ( 65776L , 74 , 7892320L ) ;
    primitive ( 65777L , 74 , 7892321L ) ;
  } 
  primitive ( 65778L , 74 , 7892322L ) ;
  primitive ( 65784L , 103 , 0 ) ;
  primitive ( 65779L , 74 , 7892323L ) ;
  primitive ( 65780L , 74 , 7892324L ) ;
  primitive ( 65781L , 74 , 7892337L ) ;
  primitive ( 65782L , 74 , 7892338L ) ;
  primitive ( 65787L , 75 , 9006720L ) ;
  primitive ( 65788L , 75 , 9006721L ) ;
  primitive ( 65789L , 75 , 9006722L ) ;
  primitive ( 65790L , 75 , 9006723L ) ;
  primitive ( 65791L , 75 , 9006724L ) ;
  primitive ( 65792L , 75 , 9006725L ) ;
  primitive ( 65793L , 75 , 9006726L ) ;
  primitive ( 65794L , 75 , 9006727L ) ;
  primitive ( 65795L , 75 , 9006728L ) ;
  primitive ( 65796L , 75 , 9006729L ) ;
  primitive ( 65797L , 75 , 9006730L ) ;
  primitive ( 65798L , 75 , 9006731L ) ;
  primitive ( 65799L , 75 , 9006732L ) ;
  primitive ( 65800L , 75 , 9006733L ) ;
  primitive ( 65801L , 75 , 9006734L ) ;
  primitive ( 65802L , 75 , 9006735L ) ;
  primitive ( 65803L , 75 , 9006736L ) ;
  primitive ( 65804L , 75 , 9006737L ) ;
  primitive ( 65805L , 75 , 9006738L ) ;
  primitive ( 65806L , 75 , 9006739L ) ;
  primitive ( 65807L , 75 , 9006740L ) ;
  primitive ( 65808L , 75 , 9006741L ) ;
  primitive ( 65809L , 75 , 9006742L ) ;
  primitive ( 32 , 64 , 0 ) ;
  primitive ( 47 , 44 , 0 ) ;
  ...
  hash [1194654L ].v.RH = 66165L ;
  eqtb [1194654L ]= eqtb [curval ];
  primitive ( 66166L , 109 , 4 ) ;
  primitive ( 66167L , 109 , 3 ) ;
  primitive ( 66194L , 89 , 0 ) ;
  hash [1196762L ].v.RH = 66194L ;
  eqtb [1196762L ]= eqtb [curval ];
  primitive ( 66326L , 4 , 1114113L ) ;
  primitive ( 66327L , 5 , 1114114L ) ;
  hash [1194651L ].v.RH = 66327L ;
  eqtb [1194651L ]= eqtb [curval ];
  primitive ( 66328L , 5 , 1114115L ) ;
  hash [1194655L ].v.RH = 66329L ;
  hash [1194656L ].v.RH = 66329L ;
  ...
  primitive ( 66406L , 82 , 0 ) ;
  primitive ( 66407L , 82 , 1 ) ;
  primitive ( 66408L , 82 , 2 ) ;
  primitive ( 66409L , 82 , 3 ) ;
  primitive ( 66410L , 82 , 4 ) ;
  primitive ( 66411L , 82 , 5 ) ;
  primitive ( 66412L , 82 , 6 ) ;
  primitive ( 66413L , 82 , 7 ) ;
  primitive ( 65631L , 14 , 0 ) ;
  primitive ( 66459L , 14 , 1 ) ;
  primitive ( 66460L , 26 , 4 ) ;
  primitive ( 66461L , 26 , 0 ) ;
  primitive ( 66462L , 26 , 1 ) ;
  primitive ( 66463L , 26 , 2 ) ;
  primitive ( 66464L , 26 , 3 ) ;
  primitive ( 66465L , 27 , 4 ) ;
  primitive ( 66466L , 27 , 0 ) ;
  primitive ( 66467L , 27 , 1 ) ;
  primitive ( 66468L , 27 , 2 ) ;
  primitive ( 66469L , 27 , 3 ) ;
  primitive ( 65624L , 28 , 5 ) ;
  primitive ( 65603L , 29 , 1 ) ;
  primitive ( 65630L , 30 , 99 ) ;
  primitive ( 66487L , 21 , 1 ) ;
  primitive ( 66488L , 21 , 0 ) ;
  primitive ( 66489L , 22 , 1 ) ;
  primitive ( 66490L , 22 , 0 ) ;
  primitive ( 65709L , 20 , 0 ) ;
  primitive ( 66491L , 20 , 1 ) ;
  primitive ( 66492L , 20 , 2 ) ;
  primitive ( 66401L , 20 , 3 ) ;
  primitive ( 66493L , 20 , 4 ) ;
  primitive ( 66403L , 20 , 5 ) ;
  primitive ( 66494L , 20 , 109 ) ;
  primitive ( 66495L , 31 , 99 ) ;
  primitive ( 66496L , 31 , 100 ) ;
  primitive ( 66497L , 31 , 101 ) ;
  primitive ( 66498L , 31 , 102 ) ;
  primitive ( 66514L , 43 , 1 ) ;
  primitive ( 66515L , 43 , 0 ) ;
  primitive ( 66525L , 25 , 12 ) ;
  primitive ( 66526L , 25 , 11 ) ;
  primitive ( 66527L , 25 , 10 ) ;
  primitive ( 66528L , 23 , 0 ) ;
  primitive ( 66529L , 23 , 1 ) ;
  primitive ( 66530L , 24 , 0 ) ;
  primitive ( 66531L , 24 , 1 ) ;
  primitive ( 45 , 47 , 1 ) ;
  primitive ( 65639L , 47 , 0 ) ;
  primitive ( 66562L , 48 , 0 ) ;
  primitive ( 66563L , 48 , 1 ) ;
  primitive ( 66276L , 50 , 16 ) ;
  primitive ( 66277L , 50 , 17 ) ;
  primitive ( 66278L , 50 , 18 ) ;
  primitive ( 66279L , 50 , 19 ) ;
  primitive ( 66280L , 50 , 20 ) ;
  primitive ( 66281L , 50 , 21 ) ;
  primitive ( 66282L , 50 , 22 ) ;
  primitive ( 66283L , 50 , 23 ) ;
  primitive ( 66285L , 50 , 26 ) ;
  primitive ( 66284L , 50 , 27 ) ;
  primitive ( 66564L , 51 , 0 ) ;
  primitive ( 66289L , 51 , 1 ) ;
  primitive ( 66290L , 51 , 2 ) ;
  primitive ( 66271L , 53 , 0 ) ;
  primitive ( 66272L , 53 , 2 ) ;
  primitive ( 66273L , 53 , 4 ) ;
  primitive ( 66274L , 53 , 6 ) ;
  primitive ( 66584L , 52 , 0 ) ;
  primitive ( 66585L , 52 , 1 ) ;
  primitive ( 66586L , 52 , 2 ) ;
  primitive ( 66587L , 52 , 3 ) ;
  primitive ( 66588L , 52 , 4 ) ;
  primitive ( 66589L , 52 , 5 ) ;
  primitive ( 66286L , 49 , 30 ) ;
  primitive ( 66287L , 49 , 31 ) ;
  hash [1194653L ].v.RH = 66287L ;
  eqtb [1194653L ]= eqtb [curval ];
  primitive ( 66609L , 95 , 1 ) ;
  primitive ( 66610L , 95 , 2 ) ;
  primitive ( 66611L , 95 , 4 ) ;
  primitive ( 66612L , 99 , 0 ) ;
  primitive ( 66613L , 99 , 1 ) ;
  primitive ( 66614L , 99 , 2 ) ;
  primitive ( 66615L , 99 , 3 ) ;
  primitive ( 66632L , 96 , 0 ) ;
  primitive ( 66633L , 96 , 1 ) ;
  primitive ( 66634L , 97 , 0 ) ;
  primitive ( 66635L , 97 , 1 ) ;
  primitive ( 66636L , 97 , 8 ) ;
  primitive ( 66637L , 97 , 8 ) ;
  primitive ( 66638L , 97 , 9 ) ;
  primitive ( 66639L , 97 , 9 ) ;
  primitive ( 66640L , 97 , 2 ) ;
  primitive ( 66641L , 97 , 3 ) ;
  primitive ( 66642L , 97 , 4 ) ;
  primitive ( 66643L , 97 , 5 ) ;
  primitive ( 66644L , 97 , 6 ) ;
  if ( mltexp ) 
  {
    primitive ( 66645L , 97 , 7 ) ;
  } 
  primitive ( 65715L , 86 , 1207592L ) ;
  primitive ( 65719L , 86 , 5664040L ) ;
  primitive ( 66650L , 87 , 5664040L ) ;
  primitive ( 66651L , 87 , 5664040L ) ;
  primitive ( 66652L , 87 , 5664041L ) ;
  primitive ( 66653L , 87 , 5664041L ) ;
  primitive ( 65716L , 86 , 2321704L ) ;
  primitive ( 65717L , 86 , 3435816L ) ;
  primitive ( 65718L , 86 , 4549928L ) ;
  primitive ( 66654L , 87 , 4549928L ) ;
  primitive ( 65786L , 86 , 7892608L ) ;
  primitive ( 66655L , 87 , 7892608L ) ;
  primitive ( 66656L , 87 , 7892608L ) ;
  primitive ( 66657L , 87 , 7892609L ) ;
  primitive ( 66658L , 87 , 7892609L ) ;
  primitive ( 65712L , 88 , 1206824L ) ;
  primitive ( 65713L , 88 , 1207080L ) ;
  primitive ( 65714L , 88 , 1207336L ) ;
  primitive ( 66377L , 101 , 0 ) ;
  primitive ( 66389L , 101 , 1 ) ;
  primitive ( 66673L , 79 , 0 ) ;
  primitive ( 66674L , 79 , 1 ) ;
  primitive ( 66675L , 79 , 2 ) ;
  primitive ( 66676L , 79 , 3 ) ;
  primitive ( 65554L , 102 , 0 ) ;
  primitive ( 65555L , 102 , 1 ) ;
  primitive ( 65556L , 102 , 2 ) ;
  primitive ( 66685L , 102 , 3 ) ;
  primitive ( 66686L , 60 , 1 ) ;
  primitive ( 66687L , 60 , 0 ) ;
  primitive ( 66688L , 58 , 0 ) ;
  primitive ( 66689L , 58 , 1 ) ;
  primitive ( 66695L , 57 , 2321704L ) ;
  primitive ( 66696L , 57 , 3435816L ) ;
  primitive ( 66697L , 19 , 0 ) ;
  primitive ( 66698L , 19 , 1 ) ;
  primitive ( 66699L , 19 , 2 ) ;
  primitive ( 66700L , 19 , 3 ) ;
  primitive ( 66748L , 59 , 0 ) ;
  primitive ( 65922L , 59 , 1 ) ;
  writeloc = curval ;
  primitive ( 66749L , 59 , 2 ) ;
  primitive ( 66750L , 59 , 3 ) ;
  hash [1194660L ].v.RH = 66750L ;
  eqtb [1194660L ]= eqtb [curval ];
  primitive ( 66751L , 59 , 5 ) ;
  primitive ( 66752L , 59 , 6 ) ;
  primitive ( 66753L , 59 , 33 ) ;
  primitive ( 66754L , 59 , 35 ) ;
  primitive ( 66977L , 74 , 7892351L ) ;
  nonewcontrolsequence = true ;
} 
#endif /* INITEX */
void 
mainbody ( void ) 
{
  ...
  fprintf ( stdout , "%s%s%s",  "This is XeTeX, Version 3.141592653" , "-2.6" , "-0.999998"   ) ;
  else
  fprintf ( stdout , "%s%s%s",  "This is XeTeX, Version 3.141592653" , "-2.6" ,   "-0.999998" ) ;
  ...
  else outputfileextension = 66186L ;
  {
    ...
    {
      nonewcontrolsequence = false ;
      primitive ( 66755L , 59 , 41 ) ;
      primitive ( 66756L , 59 , 42 ) ;
      primitive ( 66757L , 59 , 43 ) ;
      primitive ( 66758L , 59 , 46 ) ;
      primitive ( 66759L , 73 , 1206306L ) ;
      primitive ( 66760L , 59 , 23 ) ;
      primitive ( 66816L , 71 , 3 ) ;
      primitive ( 66817L , 71 , 19 ) ;
      primitive ( 66115L , 111 , 5 ) ;
      primitive ( 66818L , 71 , 27 ) ;
      primitive ( 66819L , 111 , 33 ) ;
      primitive ( 66820L , 71 , 28 ) ;
      primitive ( 66821L , 71 , 29 ) ;
      primitive ( 66822L , 71 , 30 ) ;
      primitive ( 66823L , 71 , 31 ) ;
      primitive ( 66824L , 71 , 32 ) ;
      primitive ( 66825L , 71 , 33 ) ;
      primitive ( 66826L , 71 , 34 ) ;
      primitive ( 66827L , 71 , 35 ) ;
      primitive ( 66828L , 71 , 36 ) ;
      primitive ( 66829L , 71 , 37 ) ;
      primitive ( 66830L , 71 , 38 ) ;
      primitive ( 66831L , 71 , 39 ) ;
      primitive ( 66832L , 71 , 40 ) ;
      primitive ( 66833L , 71 , 41 ) ;
      primitive ( 66834L , 71 , 42 ) ;
      primitive ( 66835L , 111 , 34 ) ;
      primitive ( 66836L , 111 , 35 ) ;
      primitive ( 66837L , 111 , 36 ) ;
      primitive ( 66838L , 71 , 43 ) ;
      primitive ( 66839L , 71 , 44 ) ;
      primitive ( 66840L , 71 , 45 ) ;
      primitive ( 66841L , 71 , 46 ) ;
      primitive ( 66842L , 71 , 47 ) ;
      primitive ( 66843L , 71 , 48 ) ;
      primitive ( 66844L , 71 , 49 ) ;
      primitive ( 66845L , 71 , 50 ) ;
      primitive ( 66846L , 71 , 55 ) ;
      primitive ( 66847L , 111 , 37 ) ;
      primitive ( 66848L , 71 , 51 ) ;
      primitive ( 66849L , 71 , 52 ) ;
      primitive ( 66850L , 71 , 53 ) ;
      primitive ( 66851L , 71 , 54 ) ;
      primitive ( 66861L , 73 , 1206305L ) ;
      primitive ( 66862L , 74 , 7892325L ) ;
      primitive ( 66863L , 74 , 7892326L ) ;
      primitive ( 66864L , 74 , 7892327L ) ;
      primitive ( 66865L , 74 , 7892328L ) ;
      primitive ( 66866L , 74 , 7892329L ) ;
      primitive ( 66867L , 74 , 7892330L ) ;
      primitive ( 66868L , 74 , 7892331L ) ;
      primitive ( 66869L , 74 , 7892332L ) ;
      primitive ( 66870L , 74 , 7892333L ) ;
      primitive ( 66871L , 74 , 7892335L ) ;
      primitive ( 66885L , 71 , 20 ) ;
      primitive ( 66886L , 71 , 21 ) ;
      primitive ( 66887L , 71 , 22 ) ;
      primitive ( 66888L , 71 , 23 ) ;
      primitive ( 66889L , 71 , 24 ) ;
      primitive ( 66890L , 71 , 56 ) ;
      primitive ( 66891L , 71 , 57 ) ;
      primitive ( 66892L , 71 , 58 ) ;
      primitive ( 66893L , 71 , 59 ) ;
      primitive ( 66894L , 71 , 60 ) ;
      primitive ( 66895L , 71 , 61 ) ;
      primitive ( 66896L , 71 , 62 ) ;
      primitive ( 66897L , 19 , 4 ) ;
      primitive ( 66899L , 19 , 5 ) ;
      primitive ( 66900L , 112 , 1 ) ;
      primitive ( 66901L , 112 , 5 ) ;
      primitive ( 66902L , 19 , 6 ) ;
      primitive ( 66906L , 83 , 2 ) ;
      primitive ( 66288L , 49 , 1 ) ;
      primitive ( 66910L , 74 , 7892334L ) ;
      primitive ( 66911L , 74 , 7892339L ) ;
      primitive ( 66912L , 74 , 7892341L ) ;
      primitive ( 66913L , 74 , 7892342L ) ;
      primitive ( 66914L , 74 , 7892343L ) ;
      primitive ( 66915L , 74 , 7892340L ) ;
      primitive ( 66916L , 74 , 7892344L ) ;
      primitive ( 66917L , 74 , 7892347L ) ;
      primitive ( 66918L , 74 , 7892348L ) ;
      primitive ( 66919L , 74 , 7892349L ) ;
      primitive ( 66920L , 74 , 7892350L ) ;
      primitive ( 66761L , 59 , 44 ) ;
      primitive ( 66762L , 59 , 45 ) ;
      primitive ( 66921L , 33 , 6 ) ;
      primitive ( 66922L , 33 , 7 ) ;
      primitive ( 66923L , 33 , 10 ) ;
      primitive ( 66924L , 33 , 11 ) ;
      primitive ( 66933L , 107 , 2 ) ;
      primitive ( 66935L , 98 , 1 ) ;
      primitive ( 66164L , 105 , 1 ) ;
      primitive ( 66936L , 108 , 17 ) ;
      primitive ( 66937L , 108 , 18 ) ;
      primitive ( 66938L , 108 , 19 ) ;
      primitive ( 66939L , 108 , 20 ) ;
      primitive ( 66623L , 95 , 8 ) ;
      primitive ( 66945L , 71 , 67 ) ;
      primitive ( 66946L , 71 , 68 ) ;
      primitive ( 66947L , 71 , 69 ) ;
      primitive ( 66948L , 71 , 70 ) ;
      primitive ( 66952L , 71 , 25 ) ;
      primitive ( 66953L , 71 , 26 ) ;
      primitive ( 66954L , 71 , 63 ) ;
      primitive ( 66955L , 71 , 64 ) ;
      primitive ( 66956L , 71 , 65 ) ;
      primitive ( 66957L , 71 , 66 ) ;
      primitive ( 66958L , 18 , 5 ) ;
      primitive ( 66959L , 113 , 5 ) ;
      primitive ( 66960L , 113 , 6 ) ;
      primitive ( 66961L , 113 , 7 ) ;
      primitive ( 66962L , 113 , 8 ) ;
      primitive ( 66963L , 113 , 9 ) ;
      primitive ( 66968L , 24 , 2 ) ;
      primitive ( 66969L , 24 , 3 ) ;
      primitive ( 66970L , 85 , 1206563L ) ;
      primitive ( 66971L , 85 , 1206564L ) ;
      primitive ( 66972L , 85 , 1206565L ) ;
      primitive ( 66973L , 85 , 1206566L ) ;
    ...
    magicoffset = strstart [( 66320L ) - 65536L ]- 9 * 16 ;
    if ( interaction == 0 ) 
    selector = 16 ;
    else selector = 17 ;
