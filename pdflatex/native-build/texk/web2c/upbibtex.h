...
void markerror (void);
void markfatal (void);
cstring zbibmakecstring (strnumber s);
...
boolean zstrendswith (strnumber s,strnumber ext);
...
boolean zischarkanjiupbibtex (integer c);
#define ischarkanjiupbibtex(c) zischarkanjiupbibtex((integer) (c))
