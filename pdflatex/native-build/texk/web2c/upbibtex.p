...
label 9998{109:},31{:109}{146:},32,9932{:146};const{14:}hashbase=1;
quotenextfn=hashbase-1;BUFSIZE=20000;minprintline=3;MAXPRINTLINE=60;
...
{:14}{333:}numbltinfns=38;{:333}type{22:}ASCIIcode=0..255;
{:22}{31:}lextype=0..5;idtype=0..1;
{:31}{36:}alphafile=packed file of ASCIIcode;
{:36}{42:}bufpointer=integer;buftype=^ASCIIcode;
{:42}{49:}poolpointer=integer;strnumber=integer;
{:49}{64:}hashloc=integer;hashpointer=integer;strilk=0..14;
{:64}{73:}pdsloc=1..12;pdslen=0..12;pdstype=constcstring;
{:73}{105:}auxnumber=0..auxstacksize;{:105}{118:}bibnumber=integer;
{:118}{130:}citenumber=integer;{:130}{160:}fnclass=0..8;
wizfnloc=integer;intentloc=integer;strentloc=integer;strglobloc=integer;
fieldloc=integer;hashptr2=quotenextfn..endofdef;
{:160}{291:}litstkloc=integer;stktype=0..4;
{:291}{332:}bltinrange=0..numbltinfns;
{:332}var{2:}standardinput,standardoutput:text;
{:2}{16:}poolsize:integer;maxprintline:integer;maxbibfiles:integer;
maxcites:integer;wizfnspace:integer;entstrsize:integer;
globstrsize:integer;maxglobstrs:integer;maxfields:integer;
litstksize:integer;maxstrings:integer;hashsize:integer;
hashprime:integer;hashmax:integer;endofdef:integer;undefined:integer;
bad:integer;{:16}{19:}history:0..3;errcount:integer;
...
{:37}{41:}bufsize:integer;buffer:buftype;last:bufpointer;
{:41}{43:}svbuffer:buftype;svptr1:bufpointer;svptr2:bufpointer;
tmpptr,tmpendptr:integer;{:43}{48:}strpool:^ASCIIcode;
strstart:^poolpointer;poolptr:poolpointer;strptr:strnumber;
strnum:strnumber;pptr1,pptr2:poolpointer;
{:48}{65:}hashnext:^hashpointer;hashtext:^strnumber;hashilk:^strilk;
ilkinfo:^integer;hashused:integer;hashfound:boolean;dummyloc:hashloc;
{:65}{74:}sauxextension:strnumber;slogextension:strnumber;
sbblextension:strnumber;sbstextension:strnumber;sbibextension:strnumber;
sbstarea:strnumber;sbibarea:strnumber;{:74}{76:}predefloc:hashloc;
{:76}{78:}commandnum:integer;{:78}{80:}bufptr1:bufpointer;
bufptr2:bufpointer;{:80}{89:}scanresult:0..3;
{:89}{91:}tokenvalue:integer;{:91}{97:}auxnamelength:integer;
...
logfile:alphafile;bblfile:alphafile;{:104}{117:}biblist:^strnumber;
bibptr:bibnumber;numbibfiles:bibnumber;bibseen:boolean;
bibfile:^alphafile;{:117}{124:}bstseen:boolean;bststr:strnumber;
bstfile:alphafile;{:124}{129:}citelist:^strnumber;citeptr:citenumber;
...
allmarker:citenumber;{:129}{147:}bbllinenum:integer;bstlinenum:integer;
{:147}{161:}fnloc:hashloc;wizloc:hashloc;literalloc:hashloc;
...
crossrefnum:fieldloc;nofields:boolean;{:161}{163:}entryseen:boolean;
readseen:boolean;readperformed:boolean;readingcompleted:boolean;
readcompleted:boolean;{:163}{195:}implfnnum:integer;
{:195}{219:}biblinenum:integer;entrytypeloc:hashloc;typelist:^hashptr2;
...
numpreamblestrings:bibnumber;{:219}{247:}bibbracelevel:integer;
{:247}{290:}litstack:^integer;litstktype:^stktype;litstkptr:litstkloc;
...
bltinptr:bltinrange;endifn('NO_BIBTEX_STAT'){:331}{337:}snull:strnumber;
sdefault:strnumber;st:strnumber;sl:strnumber;su:strnumber;
spreamble:^strnumber;{:337}{344:}poplit1,poplit2,poplit3:integer;
...
prevcolon:boolean;{:365}{469:}verbose:cinttype;
{:469}{472:}mincrossrefs:integer;{:472}{12:}{3:}procedure printanewline;
...
end;{:18}{38:}function bibmakecstring(s:strnumber):cstring;
var cstr:cstring;i:poolpointer;
begin cstr:=xmallocarray(ASCIIcode,(strstart[s+1]-strstart[s])+1);
for i:=0 to(strstart[s+1]-strstart[s])-1 do begin cstr[i]:=strpool[
strstart[s]+i];end;cstr[(strstart[s+1]-strstart[s])]:=0;
bibmakecstring:=cstr;10:end;{:38}{44:}procedure printoverflow;
begin begin write(logfile,'Sorry---you''ve exceeded BibTeX''s ');
write(standardoutput,'Sorry---you''ve exceeded BibTeX''s ');end;
markfatal;end;{:44}{45:}procedure printconfusion;
...
markfatal;end;{:45}{46:}procedure bufferoverflow;
...
BUFSIZE);end;{:46}{47:}function inputln(var f:alphafile):boolean;
...
POOLSIZE);end;{:53}{59:}{:59}{82:}procedure outtoken(var f:alphafile);
...
end;{:82}{95:}procedure printbadinputline;var bfptr:bufpointer;
...
markerror;end;{:95}{96:}procedure printskippingwhateverremains;
...
begin writeln(logfile);end;end;{:108}{111:}procedure auxerrprint;
...
end end;{:111}{112:}procedure auxerrillegalanotherprint(cmdnum:integer);
...
{:112}{113:}procedure auxerrnorightbraceprint;
...
{:115}{121:}function strendswith(s:strnumber;ext:strnumber):boolean;
var i:integer;stridx,extidx:integer;strchar,extchar:ASCIIcode;
begin strendswith:=false;
if((strstart[ext+1]-strstart[ext])>(strstart[s+1]-strstart[s]))then goto
10;stridx:=(strstart[s+1]-strstart[s])-1;
extidx:=(strstart[ext+1]-strstart[ext])-1;
while(extidx>=0)do begin strchar:=strpool[strstart[s]+stridx];
extchar:=strpool[strstart[ext]+extidx];if(strchar<>extchar)then goto 10;
stridx:=stridx-1;extidx:=extidx-1;end;strendswith:=true;10:end;
procedure printbibname;begin printapoolstr(biblist[bibptr]);
if not strendswith(biblist[bibptr],sbibextension)then printapoolstr(
sbibextension);printanewline;end;procedure logprbibname;
begin begin outpoolstr(logfile,biblist[bibptr]);end;
if not strendswith(biblist[bibptr],sbibextension)then begin outpoolstr(
logfile,sbibextension);end;begin writeln(logfile);end;end;
...
{:138}{144:}procedure auxend1errprint;
...
markerror;end;{:144}{148:}procedure bstlnnumprint;
begin begin write(logfile,'--line ',bstlinenum:0,' of file ');
write(standardoutput,'--line ',bstlinenum:0,' of file ');end;
printbstname;end;{:148}{149:}procedure bsterrprintandlookforblankline;
begin begin write(logfile,'-');write(standardoutput,'-');end;
...
goto 9998;end;end;{:157}{158:}procedure printfnclass(fnloc:hashloc);
...
{:158}{159:}ifdef('TRACE')procedure traceprfnclass(fnloc:hashloc);
...
others:unknwnfunctionclassconfusion end;end;
endif('TRACE'){:159}{165:}procedure idscanningconfusion;
...
goto 9998;end;end;{:165}{166:}procedure bstidprint;
...
end;end;{:221}{222:}procedure bibwarnprint;begin biblnnumprint;
markwarning;end;
...
goto 10;end;10:end;
{:229}{230:}procedure biboneoftwoprint(char1,char2:ASCIIcode);label 10;
...
{:233}{234:}procedure macrowarnprint;
...
{:284}{293:}procedure bstexwarnprint;
...
end;{:293}{294:}procedure bstmildexwarnprint;
begin if(messwithentries)then begin begin write(logfile,' for entry ');
write(standardoutput,' for entry ');end;
printapoolstr(citelist[citeptr]);end;printanewline;
...
bstexwarnprint;end;end;{:295}{310:}procedure illeglliteralconfusion;
...
goto 9998;end;end;{:310}{311:}procedure printstklit(stklt:integer;
...
{:368}{373:}procedure caseconversionconfusion;
begin begin begin write(logfile,'Unknown type of case conversion');
write(standardoutput,'Unknown type of case conversion');end;
printconfusion;goto 9998;end;end;
{:373}{456:}procedure traceandstatprinting;
begin ifdef('TRACE'){457:}begin if(numbibfiles=1)then begin writeln(
...
strentptr:=strentptr+1;end;end;end{:460};
...
endif('TRACE')ifndef('NO_BIBTEX_STAT'){465:}begin begin write(logfile,
...
bltinptr:=bltinptr+1;end;end{:465};endifn('NO_BIBTEX_STAT')end;
{:456}{58:}procedure startname(filename:strnumber);var pptr:poolpointer;
...
nameoffile[namelength+1]:=0;end;
{:60}{61:}{:61}{54:}function makestring:strnumber;
...
bfptr,len:bufpointer);var i:bufpointer;ch:integer;
begin if(len>0)then for i:=bfptr to bfptr+len-1 do if((buf[i]>=65)and(
buf[i]<=90))then begin buf[i]:=buf[i]+32;
end else if((isinternalUPTEX)and(buf[i]>=195)and(buf[i]<=212))then begin
ch:=fromBUFF(buf,i+2,i);
if(((ch>=192)and(ch<=222)and(ch<>215))or((ch>=913)and(ch<=938)and(ch<>
930))or((ch>=1040)and(ch<=1071)))then begin ch:=toBUFF(ch+32);
buf[i]:=BYTE3(ch);buf[i+1]:=BYTE4(ch);
end else if(((ch>=256)and(ch<=311)and((ch mod 2)=0))or((ch>=313)and(ch<=
328)and((ch mod 2)=1))or((ch>=330)and(ch<=375)and((ch mod 2)=0))or((ch>=
377)and(ch<=382)and((ch mod 2)=1))or((ch>=880)and(ch<=883)and((ch mod 2)
=0))or(ch=886)or((ch>=984)and(ch<=1007)and((ch mod 2)=0))or(ch=1015)or(
ch=1018)or((ch>=1120)and(ch<=1153)and((ch mod 2)=0))or((ch>=1162)and(ch
<=1215)and((ch mod 2)=0))or((ch>=1217)and(ch<=1230)and((ch mod 2)=1))or(
(ch>=1232)and(ch<=1327)and((ch mod 2)=0)))then begin ch:=toBUFF(ch+1);
buf[i]:=BYTE3(ch);buf[i+1]:=BYTE4(ch);
end else if(ch=376)then begin ch:=toBUFF(255);buf[i]:=BYTE3(ch);
buf[i+1]:=BYTE4(ch);
end else if((ch>=1024)and(ch<=1039))then begin ch:=toBUFF(ch+80);
buf[i]:=BYTE3(ch);buf[i+1]:=BYTE4(ch);
end else if(ch=1216)then begin ch:=toBUFF(1231);buf[i]:=BYTE3(ch);
buf[i+1]:=BYTE4(ch);end end end;
{:62}{63:}procedure uppercase(var buf:buftype;bfptr,len:bufpointer);
var i:bufpointer;ch:integer;
begin if(len>0)then for i:=bfptr to bfptr+len-1 do if((buf[i]>=97)and(
buf[i]<=122))then begin buf[i]:=buf[i]-32;
end else if((isinternalUPTEX)and(buf[i]>=195)and(buf[i]<=212))then begin
ch:=fromBUFF(buf,i+2,i);
if(((ch>=224)and(ch<=254)and(ch<>247))or((ch>=945)and(ch<=970)and(ch<>
962))or((ch>=1072)and(ch<=1103)))then begin ch:=toBUFF(ch-32);
buf[i]:=BYTE3(ch);buf[i+1]:=BYTE4(ch);
end else if(((ch>=256)and(ch<=311)and((ch mod 2)=1))or((ch>=313)and(ch<=
328)and((ch mod 2)=0))or((ch>=330)and(ch<=375)and((ch mod 2)=1))or((ch>=
377)and(ch<=382)and((ch mod 2)=0))or((ch>=880)and(ch<=883)and((ch mod 2)
=1))or(ch=887)or((ch>=984)and(ch<=1007)and((ch mod 2)=1))or(ch=1016)or(
ch=1019)or((ch>=1120)and(ch<=1153)and((ch mod 2)=1))or((ch>=1162)and(ch
<=1215)and((ch mod 2)=1))or((ch>=1217)and(ch<=1230)and((ch mod 2)=0))or(
(ch>=1232)and(ch<=1327)and((ch mod 2)=1)))then begin ch:=toBUFF(ch-1);
buf[i]:=BYTE3(ch);buf[i+1]:=BYTE4(ch);
end else if(ch=223)then begin buf[i]:=83;buf[i+1]:=83;
end else if(ch=255)then begin ch:=toBUFF(376);buf[i]:=BYTE3(ch);
buf[i+1]:=BYTE4(ch);
end else if((ch>=1104)and(ch<=1119))then begin ch:=toBUFF(ch-80);
buf[i]:=BYTE3(ch);buf[i+1]:=BYTE4(ch);
end else if(ch=1231)then begin ch:=toBUFF(1216);buf[i]:=BYTE3(ch);
buf[i+1]:=BYTE4(ch);end end end;
...
k:bufpointer;strnum:strnumber;begin{69:}begin h:=0;k:=j;
while(k<j+l)do begin h:=h+h+buf[k];while(h>=hashprime)do h:=h-hashprime;
k:=k+1;end;end{:69};p:=h+hashbase;hashfound:=false;strnum:=0;
...
end else begin strnum:=hashtext[p];end;end{:70};
if(hashnext[p]=0)then begin if(not insertit)then goto 45;
{71:}begin if(hashtext[p]>0)then begin repeat if((hashused=hashbase))
...
{:77}{198:}procedure inttoASCII(theint:integer;var intbuf:buftype;
...
endif('TRACE')if(rightend-leftend<10)then{304:}begin for insertptr:=
...
{:336}{482:}function ischarkanjiupbibtex(c:integer):boolean;label 10;
var k:integer;begin ischarkanjiupbibtex:=true;
if(isinternalUPTEX)then begin k:=kcatcodekey(c);
if k=37 then goto 10 else if(k>=104)and(k<=105)then goto 10 else if(k>=
108)and(k<=109)then goto 10 else if k=110 then goto 10 else if k=111
then goto 10 else if(k>=112)and(k<=114)then goto 10 else if k=115 then
goto 10 else if k=118 then goto 10 else if k=120 then goto 10 else if k=
136 then goto 10 else if k=147 then goto 10 else if k=148 then goto 10
else if k=153 then goto 10 else if(k>=282)and(k<=285)then goto 10 else
if(k>=332)and(k<=342)then goto 10 else if k=510 then goto 10 else if k=
511 then goto 10;end else if ischarkanji(c)then goto 10;
ischarkanjiupbibtex:=false;10:end;
{:482}{83:}function scan1(char1:ASCIIcode):boolean;
...
{:183}{184:}procedure printrecursionillegal;
...
{:186}{187:}procedure scanfndef(fnhashloc:hashloc);label 25,10;
...
singleptr:=singleptr+1;end;end{:190};34:{191:}begin bufptr2:=bufptr2+1;
...
if(singleptr=singlefnspace)then begin BIBXRETALLOC('singl_function',
singlfunction,hashptr2,singlefnspace,singlefnspace+SINGLEFNSPACE);end;
singleptr:=singleptr+1;end;end{:191};39:{192:}begin bufptr2:=bufptr2+1;
...
if(singleptr=singlefnspace)then begin BIBXRETALLOC('singl_function',
singlfunction,hashptr2,singlefnspace,singlefnspace+SINGLEFNSPACE);end;
singleptr:=singleptr+1;end;end end{:193};end{:192};
123:{194:}begin exbuf[0]:=39;inttoASCII(implfnnum,exbuf,1,endofnum);
...
end{:194};others:{199:}begin if(scan2white(125,37))then;
...
if(singleptr=singlefnspace)then begin BIBXRETALLOC('singl_function',
singlfunction,hashptr2,singlefnspace,singlefnspace+SINGLEFNSPACE);end;
singleptr:=singleptr+1;end;end;end{:199}end{:189};
...
{200:}begin begin singlfunction[singleptr]:=endofdef;
if(singleptr=singlefnspace)then begin BIBXRETALLOC('singl_function',
singlfunction,hashptr2,singlefnspace,singlefnspace+SINGLEFNSPACE);end;
...
{:187}{228:}function eatbibwhitespace:boolean;label 10;
...
begin if(exbufptr>=bufsize)then begin begin write(logfile,
'Field filled up at ',32,', reallocating.');end;begin writeln(logfile);
end;bufferoverflow;end;exbuf[exbufptr]:=32;exbufptr:=exbufptr+1;end;
...
begin if(exbufptr>=bufsize)then begin begin write(logfile,
'Field filled up at ',123,', reallocating.');end;begin writeln(logfile);
end;bufferoverflow;end;exbuf[exbufptr]:=123;exbufptr:=exbufptr+1;end;
bufptr2:=bufptr2+1;
begin if((lexclass[buffer[bufptr2]]=1)or(bufptr2=last))then if(not
compressbibwhite)then goto 10;end;
...
begin if(exbufptr>=bufsize)then begin begin write(logfile,
'Field filled up at ',125,', reallocating.');end;begin writeln(logfile);
end;bufferoverflow;end;exbuf[exbufptr]:=125;exbufptr:=exbufptr+1;end;
bufptr2:=bufptr2+1;
begin if((lexclass[buffer[bufptr2]]=1)or(bufptr2=last))then if(not
...
others:begin begin if(exbufptr>=bufsize)then begin begin write(logfile,
'Field filled up at ',buffer[bufptr2],', reallocating.');end;
begin writeln(logfile);end;bufferoverflow;end;
exbuf[exbufptr]:=buffer[bufptr2];exbufptr:=exbufptr+1;end;
bufptr2:=bufptr2+1;
begin if((lexclass[buffer[bufptr2]]=1)or(bufptr2=last))then if(not
...
begin write(logfile,'Field filled up at ',buffer[tmpptr],
', reallocating.');end;begin writeln(logfile);end;bufferoverflow;end;
exbuf[exbufptr]:=buffer[tmpptr];exbufptr:=exbufptr+1;end;
tmpptr:=tmpptr+1;end;end;end{:258};
...
)then begin begin if(exbufptr>=bufsize)then begin begin write(logfile,
'Field filled up at ',32,', reallocating.');end;begin writeln(logfile);
end;bufferoverflow;end;exbuf[exbufptr]:=32;exbufptr:=exbufptr+1;end;
tmpptr:=tmpptr+1;
...
begin if(exbufptr>=bufsize)then begin begin write(logfile,
'Field filled up at ',strpool[tmpptr],', reallocating.');end;
begin writeln(logfile);end;bufferoverflow;end;
exbuf[exbufptr]:=strpool[tmpptr];exbufptr:=exbufptr+1;
end else if(exbuf[exbufptr-1]<>32)then begin if(exbufptr>=bufsize)then
begin begin write(logfile,'Field filled up at ',32,', reallocating.');
end;begin writeln(logfile);end;bufferoverflow;end;exbuf[exbufptr]:=32;
exbufptr:=exbufptr+1;end;tmpptr:=tmpptr+1;end;end{:260};end;
...
endif('TRACE')if(atbibcommand)then{262:}begin case(commandnum)of 1:begin
...
end;end;{:309}{312:}procedure printwrongstklit(stklt:integer;
...
bstexwarnprint;end;end;{:312}{314:}procedure poptopandprint;
...
end;{:314}{315:}procedure popwholestack;
...
goto 9998;end;end;end;{:317}{318:}procedure addpoolbufandpush;
...
while(((lexclass[outbuf[outbufptr]]<>1)or(outbuf[outbufptr-1]>127))and(
outbufptr>=minprintline))do outbufptr:=outbufptr-1;
if(outbufptr=minprintline-1)then{324:}begin outbufptr:=maxprintline+1;
while(outbufptr<endptr)do if(lexclass[outbuf[outbufptr]]<>1)or(outbuf[
outbufptr-1]>127)then outbufptr:=outbufptr+1 else goto 16;
...
entrystrs[(strentptr)*(entstrsize+1)+(entchrptr)]:=127;end end{:357};
...
end;glbstrend[strglbptr]:=globchrptr;end;end end{:359};
...
bstexwarnprint;end;end end;end;{:354}{360:}procedure xaddperiod;
...
end else{362:}begin if(poplit1<cmdstrptr)then begin begin while(poolptr+
...
pushlitstk(makestring,1);end{:362};
others:{362:}begin if(poplit1<cmdstrptr)then begin begin while(poolptr+(
strstart[poplit1+1]-strstart[poplit1])+1>poolsize)do pooloverflow;end;
spptr:=strstart[poplit1];spend:=strstart[poplit1+1];
while(spptr<spend)do begin begin strpool[poolptr]:=strpool[spptr];
poolptr:=poolptr+1;end;spptr:=spptr+1;end;
...
begin while(poolptr+1>poolsize)do pooloverflow;end;end;
begin strpool[poolptr]:=46;poolptr:=poolptr+1;end;
pushlitstk(makestring,1);end{:362};end;end;
if(isinternalUPTEX)then begin case(fromBUFF(strpool,spptr+1,spptr-2))of
12290,65294,65311,65281,8263,8252,8253,8264,8265:begin if(litstack[
litstkptr]>=cmdstrptr)then begin strptr:=strptr+1;
poolptr:=strstart[strptr];end;litstkptr:=litstkptr+1;end;
others:{362:}begin if(poplit1<cmdstrptr)then begin begin while(poolptr+(
strstart[poplit1+1]-strstart[poplit1])+1>poolsize)do pooloverflow;end;
spptr:=strstart[poplit1];spend:=strstart[poplit1+1];
while(spptr<spend)do begin begin strpool[poolptr]:=strpool[spptr];
...
begin while(poolptr+1>poolsize)do pooloverflow;end;end;
begin strpool[poolptr]:=46;poolptr:=poolptr+1;end;
pushlitstk(makestring,1);end{:362};end;end;end;end;end{:361};end;
...
bstexwarnprint;end;end;end{:366};exbuflength:=0;addbufpool(poplit2);
...
if(poptyp1<>1)then begin printwrongstklit(poplit1,poptyp1,1);
pushlitstk(0,0);
end else if((strstart[poplit1+1]-strstart[poplit1])=multibytelen(strpool
[strstart[poplit1]]))then begin if((strstart[poplit1+1]-strstart[poplit1
])=1)then pushlitstk(strpool[strstart[poplit1]],0)else pushlitstk(toDVI(
fromBUFF(strpool,strstart[poplit1]+(strstart[poplit1+1]-strstart[poplit1
]),strstart[poplit1])),0)end else begin begin write(logfile,'"');
write(standardoutput,'"');end;printapoolstr(poplit1);
begin begin write(logfile,'" isn''t a single character');
write(standardoutput,'" isn''t a single character');end;bstexwarnprint;
end;pushlitstk(0,0);end end;{:377}{378:}procedure xcite;
...
{:380}{382:}procedure xformatname;label 16,17,52;
begin poplitstk(poplit1,poptyp1);poplitstk(poplit2,poptyp2);
...
write(standardoutput,'"');end;bstexwarnprint;end;end end{:383};
{387:}begin{388:}begin while(exbufptr>exbufxptr)do case(lexclass[exbuf[
...
goto 9998;end;end{:395};exbuflength:=0;addbufpool(poplit1);
figureouttheformattedname;addpoolbufandpush;end;end;
{:382}{422:}procedure xinttochr;var k:integer;
begin poplitstk(poplit1,poptyp1);
if(poptyp1<>0)then begin printwrongstklit(poplit1,poptyp1,0);
pushlitstk(snull,1);end else begin k:=poplit1;
if(poplit1>127)then k:=fromDVI(poplit1);
if((poplit1<0)or((poplit1>127)and(k=0)))then begin begin begin write(
logfile,poplit1:0,' isn''t valid character code');
write(standardoutput,poplit1:0,' isn''t valid character code');end;
bstexwarnprint;end;pushlitstk(snull,1);
end else begin begin while(poolptr+4>poolsize)do pooloverflow;end;
k:=toBUFF(k);if(BYTE1(k)>0)then begin strpool[poolptr]:=BYTE1(k);
poolptr:=poolptr+1;end;
if(BYTE2(k)>0)then begin strpool[poolptr]:=BYTE2(k);poolptr:=poolptr+1;
end;if(BYTE3(k)>0)then begin strpool[poolptr]:=BYTE3(k);
poolptr:=poolptr+1;end;begin strpool[poolptr]:=BYTE4(k);
poolptr:=poolptr+1;end;pushlitstk(makestring,1);end;end;end;
{:422}{423:}procedure xinttostr;begin poplitstk(poplit1,poptyp1);
if(poptyp1<>0)then begin printwrongstklit(poplit1,poptyp1,0);
pushlitstk(snull,1);
...
var tps,tpe:poolpointer;poplit2saved,mbltpe:integer;
begin poplitstk(poplit1,poptyp1);poplitstk(poplit2,poptyp2);
poplitstk(poplit3,poptyp3);
if(poptyp1<>0)then begin printwrongstklit(poplit1,poptyp1,0);
pushlitstk(snull,1);
...
end else{438:}begin poplit2saved:=poplit2;
if(poplit2>0)then begin if(poplit1>splength-(poplit2-1))then poplit1:=
splength-(poplit2-1);spptr:=strstart[poplit3]+(poplit2-1);
spend:=spptr+poplit1;
if(poplit2=1)then if(poplit3>=cmdstrptr)then begin tpe:=strstart[poplit3
];mbltpe:=0;
while tpe<strstart[poplit3+1]do begin mbltpe:=multibytelen(strpool[tpe])
;if mbltpe<0 or(strstart[poplit3+1]<tpe+mbltpe)then break;
tpe:=tpe+mbltpe;if spend<=tpe then break;end;strstart[poplit3+1]:=tpe;
begin strptr:=strptr+1;poolptr:=strstart[strptr];end;
...
tps:=strstart[poplit3];tpe:=tps;mbltpe:=0;
while tpe<strstart[poplit3+1]do begin if multibytelen(strpool[tpe])<0 or
(strstart[poplit3+1]<tpe+multibytelen(strpool[tpe]))then break;
mbltpe:=multibytelen(strpool[tpe]);tpe:=tpe+mbltpe;
if tpe<=spptr then tps:=tpe;if spend<=tpe then break;end;
if(poplit2saved>1)and(tps=strstart[poplit3])then if multibytelen(strpool
[tps])>=0 then tps:=tps+multibytelen(strpool[tps]);
if(poplit2saved<-1)and(tpe=strstart[poplit3+1])then tpe:=tpe-mbltpe;
if tps>tpe then tpe:=tps;spptr:=tps;spend:=tpe;
...
end else numtextchars:=numtextchars+1;end;spend:=spxptr1;end{:445};
...
poplit1);end;{:454}{481:}procedure xiskanjistr;label 10;
var ctmp,clen:integer;begin poplitstk(poplit1,poptyp1);
if poptyp1<>1 then begin printwrongstklit(poplit1,poptyp1,1);
pushlitstk(0,0);end else begin spptr:=strstart[poplit1];
spend:=strstart[poplit1+1];
while spptr<spend do begin clen:=multibytelen(strpool[spptr]);
if spptr+clen<=spend then ctmp:=fromBUFF(strpool,spptr+clen,spptr)else
ctmp:=strpool[spptr];
if ischarkanjiupbibtex(ctmp)then begin pushlitstk(1,0);goto 10;
end else begin if spptr+clen<=spend then spptr:=spptr+clen else spptr:=
spptr+1;end;end;pushlitstk(0,0);end;10:end;
{:481}{325:}procedure executefn(exfnloc:hashloc);{343:}label 51;
...
endif('TRACE')case(fntype[exfnloc])of 0:{341:}begin ifndef(
...
typelist[citeptr]=0)then else executefn(typelist[citeptr]);end{:363};
...
51:end{:449};35:xwidth;36:xwrite;37:xiskanjistr;
...
goto 9998;end end;end{:341};1:{326:}begin wizptr:=ilkinfo[exfnloc];
...
end{:326};2:pushlitstk(ilkinfo[exfnloc],0);
...
end{:329};7:pushlitstk(ilkinfo[exfnloc],0);
...
end;globchrptr:=globchrptr+1;end;pushlitstk(makestring,1);end;end{:330};
others:unknwnfunctionclassconfusion end;end;
{:325}{:342}{100:}procedure getthetoplevelauxfilename;label 41,46;
var i:0..255;
begin{483:}if(isinternalUPTEX)then begin for i:=128 to 191 do lexclass[i
]:=2;for i:=192 to 193 do lexclass[i]:=0;
...
charwidth[143]:=0;end;
{:483}nameoffile:=xmallocarray(ASCIIcode,strlen(cmdline(optind))+5);
...
goto 46;end;{106:}begin namelength:=auxnamelength;
...
then begin samwrongfilenameprint;goto 46;end;end{:106};
{107:}begin namelength:=auxnamelength;addextension(sauxextension);
nameptr:=1;
...
printconfusion;goto 9998;end;end;auxlnstack[auxptr]:=0;end{:107};
goto 41;end{:103};46:uexit(1);41:end;
...
{123:}begin if(bibptr=maxbibfiles)then begin BIBXRETALLOCNOSET(
...
endif('TRACE')bibptr:=bibptr+1;end{:123};end;10:end;
{:120}{126:}procedure auxbibstylecommand;label 10;
...
end;end{:127};10:end;{:126}{132:}procedure auxcitationcommand;
...
if((last>bufptr2+1)and(buffer[bufptr2]=125))then begin
auxerrstuffafterrightbraceprint;begin auxerrprint;goto 10;end;end;
{133:}begin ifdef('TRACE')begin outtoken(logfile);end;
begin write(logfile,' cite key encountered');end;
endif('TRACE'){134:}begin if((bufptr2-bufptr1)=1)then if(buffer[bufptr1]
...
if(hashfound)then{135:}begin ifdef('TRACE')begin writeln(logfile,
' previously');end;
...
begin auxerrprint;goto 10;end;end;
end{:135}else{136:}begin ifdef('TRACE')begin writeln(logfile);end;
...
if(not kpseinnameok(stringcast(nameoffile+1))or(not aopenin(auxfile[
auxptr],-1)and not aopeninwithdirname(auxfile[auxptr],-1,bibmakecstring(
toplevstr))))then begin begin write(logfile,
...
begin write(logfile,'A level-',auxptr:0,' auxiliary file: ');end;
logprauxname;auxlnstack[auxptr]:=0;end{:141};end{:140};10:end;
...
end;auxend2errprint;end;end;{:145}{170:}procedure bstentrycommand;
...
begin begin write(logfile,'entry');write(standardoutput,'entry');end;
begin bsterrprintandlookforblankline;goto 10;end;end;end;end;
{172:}begin ifdef('TRACE')begin outtoken(logfile);end;
...
begin begin write(logfile,'entry');write(standardoutput,'entry');end;
begin bsterrprintandlookforblankline;goto 10;end;end;end;end;
{174:}begin ifdef('TRACE')begin outtoken(logfile);end;
...
begin begin write(logfile,'entry');write(standardoutput,'entry');end;
begin bsterrprintandlookforblankline;goto 10;end;end;end;end;
{176:}begin ifdef('TRACE')begin outtoken(logfile);end;
...
{179:}begin ifdef('TRACE')begin outtoken(logfile);end;
begin writeln(logfile,' is a to be executed function');end;
endif('TRACE')if(badargumenttoken)then goto 10;end{:179};
begin if(not eatbstwhitespace)then begin eatbstprint;
begin begin write(logfile,'execute');write(standardoutput,'execute');
end;begin bsterrprintandlookforblankline;goto 10;end;end;end;end;
...
{182:}begin ifdef('TRACE')begin outtoken(logfile);end;
...
{202:}begin ifdef('TRACE')begin outtoken(logfile);end;
...
{204:}begin ifdef('TRACE')begin outtoken(logfile);end;
begin writeln(logfile,' is a to be iterated function');end;
endif('TRACE')if(badargumenttoken)then goto 10;end{:204};
begin if(not eatbstwhitespace)then begin eatbstprint;
begin begin write(logfile,'iterate');write(standardoutput,'iterate');
end;begin bsterrprintandlookforblankline;goto 10;end;end;end;end;
begin if(buffer[bufptr2]<>125)then begin bstrightbraceprint;
...
sortciteptr:=sortciteptr+1;end;end{:297};10:end;
{:203}{205:}procedure bstmacrocommand;label 10;
...
begin begin write(logfile,'macro');write(standardoutput,'macro');end;
begin bsterrprintandlookforblankline;goto 10;end;end;end;end;
{207:}begin ifdef('TRACE')begin outtoken(logfile);end;
...
end{:209};begin if(not eatbstwhitespace)then begin eatbstprint;
begin begin write(logfile,'macro');write(standardoutput,'macro');end;
begin bsterrprintandlookforblankline;goto 10;end;end;end;end;
begin if(buffer[bufptr2]<>125)then begin bstrightbraceprint;
begin begin write(logfile,'macro');write(standardoutput,'macro');end;
...
1:{242:}begin if(preambleptr=maxbibfiles)then begin BIBXRETALLOCNOSET(
'bib_list',biblist,strnumber,maxbibfiles,maxbibfiles+MAXBIBFILES);
BIBXRETALLOCNOSET('bib_file',bibfile,alphafile,maxbibfiles,maxbibfiles+
MAXBIBFILES);
BIBXRETALLOC('s_preamble',spreamble,strnumber,maxbibfiles,maxbibfiles+
...
end;{245:}begin ifdef('TRACE')begin outtoken(logfile);end;
...
bibwarnprint;end;end;}end{:245};end{:244};
begin if(not eatbibwhitespace)then begin eatbibprint;goto 10;end;end;
...
end{:246};goto 10;end{:243};others:bibcmdconfusion end;
...
{267:}begin ifdef('TRACE')begin outtoken(logfile);end;
...
26:end{:268};end;storeentry:=true;
...
end;end;end{:273};end{:267};end{:266};
begin if(not eatbibwhitespace)then begin eatbibprint;goto 10;end;end;
...
endif('TRACE'){276:}begin numcites:=citeptr;
numpreamblestrings:=preambleptr;
{277:}begin if((numcites-1)*numfields+crossrefnum>=maxfields)then begin
...
{279:}begin if((numcites-1)*numfields+crossrefnum>=maxfields)then begin
begin write(logfile,'field_info index is out of range');
write(standardoutput,'field_info index is out of range');end;
printconfusion;goto 9998;end;citeptr:=0;
while(citeptr<numcites)do begin fieldptr:=citeptr*numfields+crossrefnum;
...
citexptr)then{285:}begin if((citexptr+1)*numfields>maxfields)then begin
begin write(logfile,'field_info index is out of range');
write(standardoutput,'field_info index is out of range');end;
...
{213:}begin ifdef('TRACE')begin outtoken(logfile);end;
begin writeln(logfile,' is a to be iterated in reverse function');end;
endif('TRACE')if(badargumenttoken)then goto 10;end{:213};
begin if(not eatbstwhitespace)then begin eatbstprint;
begin begin write(logfile,'reverse');write(standardoutput,'reverse');
end;begin bsterrprintandlookforblankline;goto 10;end;end;end;end;
begin if(buffer[bufptr2]<>125)then begin bstrightbraceprint;
...
until(sortciteptr=0);end;end{:298};10:end;
{:212}{214:}procedure bstsortcommand;label 10;
...
begin bsterrprintandlookforblankline;goto 10;end;end;
{299:}begin ifdef('TRACE')begin writeln(logfile,'Sorting the entries');
end;endif('TRACE')if(numcites>1)then quicksort(0,numcites-1);
ifdef('TRACE')begin writeln(logfile,'Done sorting');end;
endif('TRACE')end{:299};10:end;{:214}{215:}procedure bststringscommand;
...
{216:}begin ifdef('TRACE')begin outtoken(logfile);end;
...
numglbstrs:=numglbstrs+1;end{:216};
begin if(not eatbstwhitespace)then begin eatbstprint;
begin begin write(logfile,'strings');write(standardoutput,'strings');
end;begin bsterrprintandlookforblankline;goto 10;end;end;end;end;end;
...
goto 9998;end end{:155};10:end;
{:154}{:217}{:12}{479:}procedure setupparams;var bounddefault:integer;
boundname:constcstring;begin kpsesetprogramname(argv[0],'upbibtex');
...
bounddefault:=MAXPRINTLINE;boundname:='max_print_line';
setupboundvariable(addressof(maxprintline),boundname,bounddefault);
if maxprintline<bounddefault then maxprintline:=bounddefault;
...
end;{:479}{480:}procedure computehashprime;var hashwant:integer;
...
{:480}{13:}procedure initialize;var{23:}i:integer;{:23}{66:}k:hashloc;
{:66}begin{17:}bad:=0;if(minprintline<3)then bad:=1;
...
charwidth[126]:=500;
{:35}{67:}for k:=hashbase to hashmax do begin hashnext[k]:=0;
hashtext[k]:=0;end;hashused:=hashmax+1;{:67}{72:}poolptr:=0;strptr:=1;
...
getthetoplevelauxfilename;end;{:13}{467:}procedure parsearguments;
const noptions=9;var longoptions:array[0..noptions]of getoptstruct;
getoptreturnval:integer;optionindex:cinttype;currentoption:0..noptions;
begin{470:}verbose:=true;{:470}{473:}mincrossrefs:=2;{:473};
{468:}currentoption:=0;longoptions[0].name:='terse';
longoptions[0].hasarg:=0;longoptions[0].flag:=addressof(verbose);
longoptions[0].val:=0;currentoption:=currentoption+1;
{:468}{471:}longoptions[currentoption].name:='min-crossrefs';
...
{:471}{474:}longoptions[currentoption].name:='help';
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;
{:474}{475:}longoptions[currentoption].name:='version';
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;
{:475}{476:}longoptions[currentoption].name:='kanji';
longoptions[currentoption].hasarg:=1;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;
longoptions[currentoption].name:='guess-input-enc';
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;
longoptions[currentoption].name:='no-guess-input-enc';
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;
{:476}{477:}longoptions[currentoption].name:='kanji-internal';
longoptions[currentoption].hasarg:=1;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;
{:477}{478:}longoptions[currentoption].name:=0;
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;{:478};
...
usagehelp(UPBIBTEXHELP,'issue@texjp.org');
end else if(strcmp(longoptions[optionindex].name,'version')=0)then begin
printversionandexit('This is upBibTeX, Version 0.99e-j0.36-u2.02',
...
stringcast(optarg),'".');
end else if(strcmp(longoptions[optionindex].name,'guess-input-enc')=0)
then begin enableguessfileenc;
end else if(strcmp(longoptions[optionindex].name,'no-guess-input-enc')=0
)then begin disableguessfileenc;
...
{:467}begin standardinput:=stdin;standardoutput:=stdout;
poolsize:=POOLSIZE;bufsize:=BUFSIZE;maxbibfiles:=MAXBIBFILES;
maxglobstrs:=MAXGLOBSTRS;maxfields:=MAXFIELDS;maxcites:=MAXCITES;
wizfnspace:=WIZFNSPACE;litstksize:=LITSTKSIZE;{102:}initkanji;
parsearguments;{:102}setupparams;
...
'This is upBibTeX, Version 0.99e-j0.36-u2.02');
write(standardoutput,'This is upBibTeX, Version 0.99e-j0.36-u2.02');end;
...
'This is upBibTeX, Version 0.99e-j0.36-u2.02');end;
...
{110:}if verbose then begin begin write(logfile,
...
endif('TRACE')31:lastcheckforauxerrors;{:110};
{151:}if(bststr=0)then goto 9932;bstlinenum:=0;bbllinenum:=1;
...
printbibname;end;traceandstatprinting;{466:}case(history)of 0:;
...
end end{:466};aclose(logfile);end{:455};
