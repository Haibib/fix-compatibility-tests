...
{:14}{333:}numbltinfns=37;{:333}type{22:}ASCIIcode=0..255;
...
{:382}{422:}procedure xinttochr;begin poplitstk(poplit1,poptyp1);
if(poptyp1<>0)then begin printwrongstklit(poplit1,poptyp1,0);
pushlitstk(snull,1);
...
begin nameoffile:=xmallocarray(ASCIIcode,strlen(cmdline(optind))+5);
...
{:154}{:217}{:12}{477:}procedure setupparams;var bounddefault:integer;
...
end;{:477}{478:}procedure computehashprime;var hashwant:integer;
...
{:478}{13:}procedure initialize;var{23:}i:integer;{:23}{66:}k:hashloc;
...
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;
{:475}{476:}longoptions[currentoption].name:=0;
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;{:476};
...
printversionandexit('This is BibTeX, Version 0.99e','Oren Patashnik',nil
...
wizfnspace:=WIZFNSPACE;litstksize:=LITSTKSIZE;{102:}parsearguments;
{:102}setupparams;bibfile:=XTALLOC(maxbibfiles+1,alphafile);
...
write(standardoutput,'This is BibTeX, Version 0.99e');end;
begin writeln(logfile,versionstring);
writeln(standardoutput,versionstring);end;
end else begin begin write(logfile,'This is BibTeX, Version 0.99e');end;
