...
{:3}{8:}procedure jumpout;begin uexit(1);end;{:8}{17:}procedure inputln;
...
'No room for TFM file!');jumpout;end;charbase[f]:=fmemptr-bc;
...
case f of 1:begin writeln(stderr,'titles!');jumpout;end;
2:begin writeln(stderr,'labels!');jumpout;end;
3:begin writeln(stderr,'pixels!');jumpout;end;
4:begin writeln(stderr,'slants!');jumpout;end;
5:begin writeln(stderr,'METAFONT logo!');jumpout;end;end;30:end;
...
begin if strptr<>c then begin writeln(stderr,'?');jumpout;end;
...
others:begin writeln(stderr,'internal error');jumpout;end;end;{82:}j:=0;
...
'Too many strings!');jumpout;end;end;while j<k do begin j:=j+1;
...
'dvi length exceeds "7FFFFFFF');jumpout;end;
...
if not(i.B0>0)then begin writeln(stderr,'Missing pixel char!');jumpout;
...
jumpout;end;fudgefactor:=(slantratio/xratio)/yratio;
...
if not(i.B0>0)then begin writeln(stderr,'Missing dot char!');jumpout;
...
'! (at byte ',curloc-1:1,')');jumpout;end end;
...
'No preamble','! (at byte ',curloc-1:1,')');jumpout;end;
...
;jumpout;end;{164:}begin if fontsnotloaded then loadfonts;
