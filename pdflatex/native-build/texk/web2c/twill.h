...
void znewblankxref (integer p);
#define newblankxref(p) znewblankxref((integer) (p))
...
integer scanconst (void);
integer scanexp (void);
...
void alphaout (void);
void zoutconst (sixteenbits n);
#define outconst(n) zoutconst((sixteenbits) (n))
void zoutid (integer p);
#define outid(p) zoutid((integer) (p))
void betaout (void);
void PhaseI (void);
void PhaseII (void);
