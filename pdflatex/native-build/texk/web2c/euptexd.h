...
typedef unsigned short extASCIIcode  ;
...
typedef struct {
  ...
  boolean dispcalledfield ;
  integer inhibitglueflagfield ;
...
EXTERN extASCIIcode trickbuf[256]  ;
...
EXTERN unsigned char oldselectorignorederr  ;
EXTERN integer systime, sysday, sysmonth, sysyear  ;
EXTERN memoryword * zeqtb  ;
EXTERN quarterword 
#define xeqlevel (zzzaa -114361)
  zzzaa[1901]  ;
...
EXTERN eightbits * fontenc  ;
EXTERN integer * fontnumext  ;
EXTERN eightbits jfmenc  ;
...
EXTERN sixteenbits * fontbc  ;
EXTERN sixteenbits * fontec  ;
...
EXTERN triepointer triemin[11905]  ;
...
EXTERN integer lastnodesubtype  ;
