{3:}{9:}{$C-,A+,D-}{[$C+,D+]}
{:9}program DVIcopy(dvifile,outfile,output);const{5:}maxfonts=400;
maxchars=750000;maxwidths=16000;maxpackets=65530;maxbytes=250000;
maxrecursion=10;stacksize=100;terminallinelength=256;
