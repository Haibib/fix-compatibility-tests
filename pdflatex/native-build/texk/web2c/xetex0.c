...
zprintcmdchr ( quarterword cmd , halfword chrcode ) 
{
  ...
  case 31 : 
    ...
    printesc ( 66498L ) ;
    else printesc ( 66495L ) ;
    break ;
  case 43 : 
    if ( chrcode == 0 ) 
    printesc ( 66515L ) ;
    else printesc ( 66514L ) ;
    break ;
  case 25 : 
    if ( chrcode == 10 ) 
    printesc ( 66527L ) ;
  ...
  case 99 : 
    ...
    printesc ( 66614L ) ;
    else printesc ( 66615L ) ;
    break ;
  case 96 : 
    if ( chrcode != 0 ) 
    printesc ( 66633L ) ;
    else printesc ( 66632L ) ;
    break ;
  case 97 : 
    switch ( chrcode ) 
    {case 0 : 
  ...
  case 58 : 
    if ( chrcode == 0 ) 
    printesc ( 66688L ) ;
    else printesc ( 66689L ) ;
    break ;
  case 57 : 
    if ( chrcode == 2321704L ) 
    printesc ( 66695L ) ;
    else printesc ( 66696L ) ;
    break ;
  case 19 : 
    switch ( chrcode ) 
    {case 1 : 
...
openlogfile ( void ) 
{
  ...
  logopened = true ;
  {
    ...
    fprintf ( logfile , "%s%s%s",  "This is XeTeX, Version 3.141592653" , "-2.6" ,     "-0.999998" ) ;
    else
    fprintf ( logfile , "%s%s%s",  "This is XeTeX, Version 3.141592653" , "-2.6" ,     "-0.999998" ) ;
...
zoutwhat ( halfword p ) 
{
  ...
  case 2 : 
	...
	else if ( j < 16 ) 
	{
	  ...
	  aopenout ( writefile [j ]) ) promptfilename ( 66791L , 66180L ) ;
	  writeopen [j ]= true ;
...
begininsertoradjust ( void ) 
{
  ...
  if ( ( curcmd == 38 ) && scankeyword ( 66521L ) ) 
...
mathac ( void ) 
{
  ...
  if ( curchr == 1 ) 
  {
    if ( scankeyword ( 66574L ) ) 
    mem [curlist .tailfield ].hh.b1 = 1 ;
    else if ( scankeyword ( 66575L ) ) 
    {
      if ( scankeyword ( 66574L ) ) 
...
zloadpicture ( boolean ispdf ) 
{
  ...
  if ( ispdf ) 
  {
    if ( scankeyword ( 66429L ) ) 
    {
      scanint () ;
      page = curval ;
    } 
    pdfboxtype = 6 ;
    if ( scankeyword ( 66796L ) ) 
    pdfboxtype = 1 ;
