{2:}program OVP2OVF(vplfile,vffile,tfmfile,output);label{3:}9999;{:3}
const{4:}ofmtype=0;maxchar=1114111;xmaxchar=1114112;xxmaxchar=1114113;
memsize=4456452;maxfont=1000;xmaxfont=1001;xxmaxfont=1002;
maxwidth=65535;maxheight=255;maxdepth=255;maxitalic=255;bufsize=3000;
maxheaderbytes=100;vfsize=800000;maxstack=100;maxparamwords=100;
maxligsteps=800000;xmaxlabel=800001;hashsize=130003;hashmult=16007;
maxkerns=100000;{:4}{214:}rulearrays=20;ruleentries=200;{:214}{226:}
gluearrays=20;glueentries=200;{:226}{238:}penaltyarrays=20;
penaltyentries=200;{:238}{250:}mvaluearrays=20;mvalueentries=200;{:250}
{262:}fvaluearrays=20;fvalueentries=200;{:262}{274:}ivaluearrays=20;
ivalueentries=200;{:274}type{24:}bytetype=0..65535;ASCIIcode=32..127;
{:24}{67:}fourbytes=record b0:bytetype;b1:bytetype;b2:bytetype;
b3:bytetype;end;{:67}{72:}fixword=integer;unsignedinteger=integer;{:72}
{79:}chartype=0..maxchar;xchartype=0..xmaxchar;xxchartype=0..xxmaxchar;
fonttype=0..maxfont;xfonttype=0..xmaxfont;headerindex=0..maxheaderbytes;
indx=xxchartype;{:79}{82:}pointer=0..memsize;{:82}{215:}
...
{:215}{227:}gluearraytype=0..gluearrays;glueentrytype=0..glueentries;
gluenode=record gnwidth:fixword;gnstretch:fixword;gnshrink:fixword;
gntype:integer;gnargtype:0..2;gnstretchorder:integer;
gnshrinkorder:integer;gnargument:integer;end;{:227}{239:}
penaltyarraytype=0..penaltyarrays;penaltyentrytype=0..penaltyentries;
penaltynode=record pnval:integer;end;{:239}{251:}
mvaluearraytype=0..mvaluearrays;mvalueentrytype=0..mvalueentries;
mvaluenode=record fnval:fixword;end;{:251}{263:}
fvaluearraytype=0..fvaluearrays;fvalueentrytype=0..fvalueentries;
fvaluenode=record fnval:fixword;end;{:263}{275:}
ivaluearraytype=0..ivaluearrays;ivalueentrytype=0..ivalueentries;
ivaluenode=record inval:integer;end;{:275}var{6:}vplfile:text;{:6}{22:}
vffile:packed file of 0..255;tfmfile:packed file of 0..255;{:22}{25:}
xord:array[0..255]of ASCIIcode;{:25}{28:}line:integer;
goodindent:integer;indent:integer;level:integer;{:28}{30:}
leftln,rightln:boolean;limit:0..bufsize;loc:0..bufsize;
buffer:array[1..bufsize]of 0..255;inputhasended:boolean;{:30}{32:}
charsonline:0..9;perfect:boolean;{:32}{37:}curchar:ASCIIcode;{:37}{45:}
start:array[1..300]of 0..3000;dictionary:array[0..3000]of ASCIIcode;
startptr:0..300;dictptr:0..3000;{:45}{47:}
curname:array[1..20]of ASCIIcode;namelength:0..20;nameptr:0..300;{:47}
{48:}nhash:array[0..306]of 0..300;curhash:0..306;{:48}{53:}
equiv:array[0..300]of bytetype;curcode:bytetype;{:53}{68:}
curbytes:fourbytes;zerobytes:fourbytes;{:68}{76:}
fractiondigits:array[1..7]of integer;{:76}{78:}
...
fontdsize:array[fonttype]of fixword;{:78}{83:}
...
topwidth,topheight,topdepth,topitalic:integer;{:83}{87:}nextd:fixword;
{:87}{90:}indexvar:array[pointer]of bytetype;excess:bytetype;{:90}{92:}
c:integer;cprime:chartype;crange:chartype;x:fixword;k:integer;{:92}
{114:}lkstepended:boolean;krnptr:0..maxkerns;{:114}{119:}
categoryremainders:array[0..256]of integer;
ivaluecategory,maxivaluecategory:integer;
gluecategory,maxgluecategory:integer;
penaltycategory,maxpenaltycategory:integer;{:119}{126:}
charextendedtag:array[chartype]of boolean;{:126}{129:}
tablesread:boolean;{:129}{132:}charoriginal:array[0..maxchar]of integer;
charrepeats:array[0..maxchar]of integer;diff:boolean;
neededspace,extrabytes:integer;{:132}{135:}
chartable:array[0..maxchar,0..8]of integer;chtable,chentry:integer;
tempvalue:integer;{:135}{141:}HEX:constcstring;{:141}{143:}
dig:array[0..32]of integer;{:143}{148:}hstack:array[0..maxstack]of 0..2;
vstack:array[0..maxstack]of 0..2;
wstack,xstack,ystack,zstack:array[0..maxstack]of fixword;
stackptr:0..maxstack;{:148}{161:}sevenunsafe:boolean;{:161}{166:}
delta:fixword;{:166}{170:}ligptr:0..maxligsteps;
...
xligcycle,yligcycle:xchartype;{:170}{181:}bc:chartype;ec:chartype;
lh:chartype;lf:unsignedinteger;notfound:boolean;tempwidth:fixword;
ncw,nco,npc:integer;{:181}{185:}j:0..maxheaderbytes;p:pointer;q:1..4;
parptr:0..maxparamwords;{:185}{188:}tab:integer;{:188}{193:}
...
nwi:integer;iarray:integer;inumber:integer;{:276}{292:}verbose:cinttype;
{:292}{295:}vplname,tfmname,vfname:constcstring;{:295}{288:}
...
begin{293:}verbose:=false;{:293};{289:}currentoption:=0;
...
{290:}longoptions[currentoption].name:='version';
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;{:290}
{291:}longoptions[currentoption].name:='verbose';
longoptions[currentoption].hasarg:=0;
longoptions[currentoption].flag:=addressof(verbose);
longoptions[currentoption].val:=1;currentoption:=currentoption+1;{:291}
{294:}longoptions[currentoption].name:=0;
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;{:294};
...
tfmname:=basenamechangesuffix(vplname,'.ovp','.ofm');end;end;{:288}
procedure initialize;var{26:}k:integer;{:26}{49:}h:0..306;{:49}{80:}
d:headerindex;{:80}{84:}c:integer;{:84}
begin kpsesetprogramname(argv[0],'ovp2ovf');parsearguments;{7:}
reset(vplfile,vplname);
if verbose then begin write(stderr,'This is OVP2OVF, Version 1.13');
writeln(stderr,versionstring);end;{:7}{23:}rewritebin(vffile,vfname);
rewritebin(tfmfile,tfmname);{:23}{27:}
...
xord['{']:=123;xord['|']:=124;xord['}']:=125;xord['~']:=126;{:27}{29:}
line:=0;goodindent:=0;indent:=0;level:=0;{:29}{31:}limit:=0;loc:=0;
leftln:=true;rightln:=true;inputhasended:=false;{:31}{33:}
charsonline:=0;perfect:=true;{:33}{46:}startptr:=1;start[1]:=0;
dictptr:=0;{:46}{50:}for h:=0 to 306 do nhash[h]:=0;{:50}{69:}
zerobytes.b0:=0;zerobytes.b1:=0;zerobytes.b2:=0;zerobytes.b3:=0;{:69}
{81:}for d:=0 to 18*4-1 do headerbytes[d]:=0;headerbytes[8]:=11;
...
for k:=65536 to maxchar do packetlength[k]:=4;{:81}{85:}
...
memory[3]:=0;link[3]:=0;memory[4]:=0;link[4]:=0;memptr:=4;{:85}{120:}
for ivaluecategory:=0 to 256 do begin categoryremainders[ivaluecategory]
:=-1;end;maxivaluecategory:=-1;maxgluecategory:=-1;
maxpenaltycategory:=-1;{:120}{127:}
for c:=0 to maxchar do charextendedtag[c]:=false;{:127}{130:}
tablesread:=false;{:130}{133:}
for chentry:=0 to maxchar do begin charoriginal[chentry]:=chentry;
charrepeats[chentry]:=0;end;{:133}{136:}
for c:=0 to maxchar do for chtable:=0 to 8 do chartable[c,chtable]:=0;
{:136}{142:}HEX:=' 0123456789ABCDEF';{:142}{171:}hashptr:=0;
yligcycle:=xmaxchar;for k:=0 to hashsize do hash[k]:=0;{:171}{182:}
npc:=-1;{:182}{209:}ofmlevel:=-1;{:209}{217:}
for rarray:=0 to rulearrays do begin npr[rarray]:=0;{220:}
begin rules[rarray,npr[rarray]].rnwidth:=0;
rules[rarray,npr[rarray]].rndepth:=0;
rules[rarray,npr[rarray]].rnheight:=0;end{:220};end;nkr:=-1;{:217}{229:}
for garray:=0 to gluearrays do begin npg[garray]:=0;{232:}
...
glues[garray,npg[garray]].gnargument:=0;end{:232};end;nkg:=-1;{:229}
{241:}for parray:=0 to penaltyarrays do begin npp[parray]:=0;{244:}
begin penalties[parray,npp[parray]].pnval:=0;end{:244};end;nkp:=-1;
{:241}{253:}for marray:=0 to mvaluearrays do begin npm[marray]:=0;{256:}
begin mvalues[marray,npm[marray]].fnval:=0;end{:256};end;nkm:=-1;{:253}
{265:}for farray:=0 to fvaluearrays do begin npf[farray]:=0;{268:}
begin fvalues[farray,npf[farray]].fnval:=0;end{:268};end;nkf:=-1;{:265}
{277:}for iarray:=0 to ivaluearrays do begin npi[iarray]:=0;{280:}
begin ivalues[iarray,npi[iarray]].inval:=0;end{:280};end;nki:=-1;{:277}
end;{:2}{34:}procedure showerrorcontext;var k:0..bufsize;
...
charsonline:=0;perfect:=false;end;{:34}{35:}procedure fillbuffer;
...
buffer[limit+1]:=' ';end;if leftln then{36:}
...
goodindent:=0;indent:=0;end;end;end{:36};end;end;{:35}{38:}
...
if curchar=62 then loc:=loc+1 else curchar:=32;end;end;{:38}{39:}
...
end;{:39}{40:}function gethex:bytetype;var a:integer;
...
gethex:=0;end else gethex:=a;end;{:40}{41:}procedure skiptoendofitem;
...
showerrorcontext;end;curchar:=32;end;{:41}{42:}
...
if vfptr=vfsize then begin if charsonline>0 then writeln(stderr,' ');
write(stderr,'I''m out of memory---increase my vfsize!');
showerrorcontext;end else vfptr:=vfptr+1;end;end;30:end;{:42}{44:}
...
showerrorcontext;end;skiptoendofitem;end;{:44}{51:}procedure lookup;
var k:0..20;j:0..3000;notfound:boolean;curhashreset:boolean;begin{52:}
curhash:=curname[1];
for k:=2 to namelength do curhash:=(curhash+curhash+curname[k])mod 307{:
52};notfound:=true;curhashreset:=false;
...
:=true;end end end end;nameptr:=nhash[curhash];end;{:51}{54:}
...
end;{:54}{59:}procedure getname;begin loc:=loc+1;level:=level+1;
...
showerrorcontext;end;curcode:=equiv[nameptr];end;{:59}{61:}
...
until curchar<>32;if t=67 then{62:}
...
showerrorcontext;end;repeat getnext until(curchar=40)or(curchar=41);end;
acc:=0;curchar:=32;end else getnext;end;
begin if(curchar>41)or(curchar<40)then loc:=loc-1;end;end{:65}
else if t=70 then{66:}
...
showerrorcontext;end;repeat getnext until(curchar=40)or(curchar=41);end;
acc:=0;curchar:=32;end;getbyte:=acc;end;{:61}{70:}
...
71:}begin if curchar>=65 then curchar:=curchar-7;
...
showerrorcontext;end;repeat getnext until(curchar=40)or(curchar=41);end;
end;getnext;end;end{:71};end;end;function getinteger:integer;
...
b3;end;{:70}{73:}function getfix:fixword;var negative:boolean;
...
showerrorcontext;end;repeat getnext until(curchar=40)or(curchar=41);
end else begin{74:}repeat getnext;if curchar=45 then begin curchar:=32;
negative:=not negative;end else if curchar=43 then curchar:=32;
until curchar<>32{:74};while(curchar>=48)and(curchar<=57)do{75:}
...
showerrorcontext;end;repeat getnext until(curchar=40)or(curchar=41);end;
acc:=0;curchar:=32;end else getnext;end{:75};intpart:=acc;acc:=0;
if curchar=46 then{77:}begin j:=0;getnext;
...
if negative then getfix:=-acc else getfix:=acc;end;{:73}{86:}
...
sortin:=memptr;end;end;end;{:86}{88:}function mincover(h:pointer;
...
if memory[p]-l<nextd then nextd:=memory[p]-l;end;mincover:=m;end;{:88}
{89:}function shorten(h:pointer;m:integer):fixword;var d:fixword;
...
k:=mincover(h,d);end;shorten:=d;end else shorten:=0;end;{:89}{91:}
...
{:91}{94:}procedure junkerror;
begin begin if charsonline>0 then writeln(stderr,' ');
write(stderr,'There''s junk here that is not in parentheses');
showerrorcontext;end;repeat getnext until(curchar=40)or(curchar=41);end;
{:94}{97:}procedure readfourbytes(l:headerindex);begin getfourbytes;
headerbytes[l]:=curbytes.b0;headerbytes[l+1]:=curbytes.b1;
headerbytes[l+2]:=curbytes.b2;headerbytes[l+3]:=curbytes.b3;end;{:97}
{98:}procedure readBCPL(l:headerindex;n:bytetype);var k:headerindex;
...
end;{:98}{112:}procedure checktag(c:integer);begin case chartag[c]of 0:;
...
showerrorcontext;end;end;end;{:112}{144:}procedure printdigs(j:integer);
begin repeat j:=j-1;write(stderr,HEX[1+dig[j]]);until j=0;end;{:144}
{145:}procedure printnumber(c:integer;form:integer);var j:0..32;
...
printdigs(j);end;{:145}{147:}procedure vfstoreset(x:integer);
...
putbyte(x div 256,vffile);putbyte(x mod 256,vffile);end;{:147}{149:}
{153:}procedure vffix(opcode:bytetype;x:fixword);var negative:boolean;
...
until k=0;end;{:153}procedure readpacket(c:integer);var cc:chartype;
...
if curchar=40 then{150:}begin getname;
...
end else begin case curcode of 210:{151:}
...
end else vfstorefnt(curfont);end{:151};211:{152:}
if curfont=fontptr then begin if charsonline>0 then writeln(stderr,' ');
write(stderr,'Character cannot be typeset in undefined font');
showerrorcontext;end else begin cc:=getcharcode;vfstoreset(cc);end{:152}
;212:{154:}begin begin vf[vfptr]:=132;
if vfptr=vfsize then begin if charsonline>0 then writeln(stderr,' ');
write(stderr,'I''m out of memory---increase my vfsize!');
showerrorcontext;end else vfptr:=vfptr+1;end;vffix(0,getfix);
vffix(0,getfix);end{:154};213,214:{155:}
...
if vfptr=vfsize then begin if charsonline>0 then writeln(stderr,' ');
write(stderr,'I''m out of memory---increase my vfsize!');
showerrorcontext;end else vfptr:=vfptr+1;end else vffix(143,x);end{:155}
;215,216:{156:}begin if curcode=215 then x:=getfix else x:=-getfix;
...
if vfptr=vfsize then begin if charsonline>0 then writeln(stderr,' ');
write(stderr,'I''m out of memory---increase my vfsize!');
showerrorcontext;end else vfptr:=vfptr+1;end else vffix(157,x);end{:156}
;217:{157:}
...
vstack[stackptr]:=v;stackptr:=stackptr+1;h:=0;v:=0;end{:157};218:{158:}
...
h:=hstack[stackptr];v:=vstack[stackptr];end{:158};219,220:{159:}
...
if vfptr-specialstart>255 then{160:}
...
end{:160}else vf[specialstart-1]:=vfptr-specialstart;end{:159};end;
finishtheproperty;end;end{:150}
...
curchar:=41;end;end;{:149}{173:}function hashinput(p,c:indx):boolean;
...
end;{174:}y:=ligkern[p].b1;t:=ligkern[p].b2;cc:=0;zz:=ligkern[p].b3;
if t>=128 then zz:=y else begin case t of 0,6:;5,11:zz:=y;1,7:cc:=1;
2:cc:=2;3:cc:=3;end;end{:174};key:=int64cast(xmaxchar)*c+y+1;
...
30:end;{:173}{175:}ifdef('notdef')function f(h,x,y:indx):indx;begin end;
...
if hash[h]<key then eval:=y else eval:=f(h,x,y);end;{:175}{176:}
...
end;end;f:=ligz[h];end;{:176}{179:}procedure outint(x:integer);
...
putbyte(x div 256,tfmfile);putbyte(x mod 256,tfmfile);end;{:179}{191:}
...
putbyte(m div 256,tfmfile);putbyte(m mod 256,tfmfile);end;{:191}{202:}
...
putbyte((x div 256)mod 256,vffile);putbyte(x mod 256,vffile);end;{:202}
{206:}procedure paramenter;begin{58:}namelength:=5;curname[16]:=83;
...
curname[11]:=79;curname[12]:=80;curname[13]:=83;curname[14]:=80;
curname[15]:=65;curname[16]:=67;curname[17]:=73;curname[18]:=78;
curname[19]:=71;curname[20]:=53;entername(43);{:58};end;
procedure vplenter;begin{57:}namelength:=6;curname[15]:=86;
...
curname[20]:=88;entername(220);{:57};end;procedure nameenter;begin{56:}
...
curname[18]:=86;curname[19]:=65;curname[20]:=76;entername(198);{:56};
vplenter;paramenter;end;procedure readligkern;begin{110:}
...
curchar:=41;end;end{:110};end;procedure outputnewinformationofm;
begin{287:}begin{285:}
...
putbyte((npi[iarray])mod 256,tfmfile);end;end{:285};{273:}
...
putbyte((npf[farray])mod 256,tfmfile);end;end{:273};{261:}
...
putbyte((npm[marray])mod 256,tfmfile);end;end{:261};{225:}
...
putbyte((npr[rarray])mod 256,tfmfile);end;end{:225};{237:}
...
putbyte((npg[garray])mod 256,tfmfile);end;end{:237};{249:}
...
putbyte((npp[parray])mod 256,tfmfile);end;end{:249};{284:}
begin for iarray:=0 to nki-1 do for inumber:=0 to npi[iarray]-1 do begin
outint(ivalues[iarray,inumber].inval);end;end{:284};{272:}
begin for farray:=0 to nkf-1 do for fnumber:=0 to npf[farray]-1 do begin
outscaled(fvalues[farray,fnumber].fnval);end;end{:272};{260:}
begin for marray:=0 to nkm-1 do for mnumber:=0 to npm[marray]-1 do begin
outscaled(mvalues[marray,mnumber].fnval);end;end{:260};{224:}
...
outscaled(rules[rarray,rnumber].rndepth);end;end{:224};{236:}
...
outscaled(glues[garray,gnumber].gnshrink);end;end{:236};{248:}
begin for parray:=0 to nkp-1 do for pnumber:=0 to npp[parray]-1 do begin
outint(penalties[parray,pnumber].pnval);end;end{:248};end{:287};end;
procedure computenewheaderofm;begin{286:}begin{283:}begin nwi:=0;
for iarray:=0 to nki do begin npi[iarray]:=npi[iarray]+1;
nwi:=nwi+npi[iarray];end;nki:=nki+1;end{:283};{271:}begin nwf:=0;
for farray:=0 to nkf do begin npf[farray]:=npf[farray]+1;
nwf:=nwf+npf[farray];end;nkf:=nkf+1;end{:271};{259:}begin nwm:=0;
for marray:=0 to nkm do begin npm[marray]:=npm[marray]+1;
nwm:=nwm+npm[marray];end;nkm:=nkm+1;end{:259};{223:}begin nwr:=0;
for rarray:=0 to nkr do begin npr[rarray]:=npr[rarray]+1;
nwr:=nwr+3*npr[rarray];end;nkr:=nkr+1;end{:223};{235:}begin nwg:=0;
for garray:=0 to nkg do begin npg[garray]:=npg[garray]+1;
nwg:=nwg+4*npg[garray];end;nkg:=nkg+1;end{:235};{247:}begin nwp:=0;
for parray:=0 to nkp do begin npp[parray]:=npp[parray]+1;
nwp:=nwp+npp[parray];end;nkp:=nkp+1;end{:247};end{:286};end;
procedure finishextendedfont;begin{128:}
...
end{:128};end;procedure outputsubfilesizes;begin{184:}
...
end;end;{:184};end;procedure computesubfilesizes;begin{183:}
...
:=bc+1;notfound:=true;ec:=maxchar;
while notfound do if(charwd[ec]>0)or(ec=0)then notfound:=false else ec:=
ec-1;if(ofmlevel=-1)and(ec>255)then begin write(stderr,'Char ');
printnumber(ec,16);
writeln(stderr,' too big for TFM (max "FF); use OFM file!');uexit(1);
end;if bc>ec then bc:=1;memory[1]:=memory[1]+1;memory[2]:=memory[2]+1;
memory[3]:=memory[3]+1;memory[4]:=memory[4]+1;{194:}{195:}labelptr:=0;
labeltable[0].rr:=-1;
...
labelptr:=labelptr+1;end{:195};
if bchar<xmaxchar then begin extralocneeded:=true;lkoffset:=1;
end else begin extralocneeded:=false;lkoffset:=0;end;{196:}
...
(nl+lkoffset)+nk+2*ne+np;end;1:begin{189:}
...
ncw:=ncw+neededspace;end;end;end;{:189};
...
{:183};end;procedure outputcharacterinfo;begin{190:}indexvar[0]:=0;
...
{:190};end;procedure readfontrulelist;begin{218:}
...
while level=1 do begin while curchar=32 do getnext;
if curchar=40 then{219:}begin getname;
...
rarray]+1;{220:}begin rules[rarray,npr[rarray]].rnwidth:=0;
rules[rarray,npr[rarray]].rndepth:=0;
rules[rarray,npr[rarray]].rnheight:=0;end{:220};end;{221:}
begin while level=2 do begin while curchar=32 do getnext;
if curchar=40 then{222:}begin getname;
...
end{:222}else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end{:221};
finishtheproperty;end;end;end{:219}
else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end;end{:218};end;
procedure readfontgluelist;begin{230:}
begin if tablesread then begin begin if charsonline>0 then writeln(
stderr,' ');
write(stderr,'All parameter tables must appear before character info');
...
while level=1 do begin while curchar=32 do getnext;
if curchar=40 then{231:}begin getname;
...
garray]+1;{232:}begin glues[garray,npg[garray]].gnwidth:=0;
glues[garray,npg[garray]].gnstretch:=0;
glues[garray,npg[garray]].gnshrink:=0;
glues[garray,npg[garray]].gntype:=0;
glues[garray,npg[garray]].gnargtype:=0;
glues[garray,npg[garray]].gnstretchorder:=0;
glues[garray,npg[garray]].gnshrinkorder:=0;
glues[garray,npg[garray]].gnargument:=0;end{:232};end;{233:}
begin while level=2 do begin while curchar=32 do getnext;
if curchar=40 then{234:}begin getname;
...
end{:234}else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end{:233};
finishtheproperty;end;end;end{:231}
else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end;end{:230};end;
procedure readfontpenaltylist;begin{242:}
begin if tablesread then begin begin if charsonline>0 then writeln(
stderr,' ');
write(stderr,'All parameter tables must appear before character info');
...
while level=1 do begin while curchar=32 do getnext;
if curchar=40 then{243:}begin getname;
...
parray]+1;{244:}begin penalties[parray,npp[parray]].pnval:=0;end{:244};
end;{245:}begin while level=2 do begin while curchar=32 do getnext;
if curchar=40 then{246:}begin getname;
...
finishtheproperty;end;end{:246}
else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end{:245};
finishtheproperty;end;end;end{:243}
else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end;end{:242};end;
procedure readfontmvaluelist;begin{254:}
begin if tablesread then begin begin if charsonline>0 then writeln(
stderr,' ');
write(stderr,'All parameter tables must appear before character info');
...
while level=1 do begin while curchar=32 do getnext;
if curchar=40 then{255:}begin getname;
...
marray]+1;{256:}begin mvalues[marray,npm[marray]].fnval:=0;end{:256};
end;{257:}begin while level=2 do begin while curchar=32 do getnext;
if curchar=40 then{258:}begin getname;
...
end;end{:258}else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end{:257};
finishtheproperty;end;end;end{:255}
else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end;end{:254};end;
procedure readfontfvaluelist;begin{266:}
begin if tablesread then begin begin if charsonline>0 then writeln(
stderr,' ');
write(stderr,'All parameter tables must appear before character info');
...
while level=1 do begin while curchar=32 do getnext;
if curchar=40 then{267:}begin getname;
...
farray]+1;{268:}begin fvalues[farray,npf[farray]].fnval:=0;end{:268};
end;{269:}begin while level=2 do begin while curchar=32 do getnext;
if curchar=40 then{270:}begin getname;
...
end;end{:270}else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end{:269};
finishtheproperty;end;end;end{:267}
else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end;end{:266};end;
procedure readfontivaluelist;begin{278:}
begin if tablesread then begin begin if charsonline>0 then writeln(
stderr,' ');
write(stderr,'All parameter tables must appear before character info');
...
while level=1 do begin while curchar=32 do getnext;
if curchar=40 then{279:}begin getname;
...
iarray]+1;{280:}begin ivalues[iarray,npi[iarray]].inval:=0;end{:280};
end;{281:}begin while level=2 do begin while curchar=32 do getnext;
if curchar=40 then{282:}begin getname;
...
finishtheproperty;end;end{:282}
else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end{:281};
finishtheproperty;end;end;end{:279}
else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end;end{:278};end;
procedure readrepeatedcharacterinfo;begin{134:}
begin if not tablesread then begin computenewheaderofm;tablesread:=true;
end;c:=getcharcode;if verbose then{146:}
begin if charsonline>=8 then begin writeln(stderr,' ');charsonline:=1;
end else begin if charsonline>0 then write(stderr,' ');
charsonline:=charsonline+1;end;printnumber(c,16);end{:146};
crange:=getbyte;
...
chartable[cprime,tab];end;end;end{:134};end;
procedure readligkerncommand;begin{111:}begin getname;
...
showerrorcontext;end;skiptoendofitem;
end else begin case curcode of 130:{113:}
...
if minnl<=nl then minnl:=nl+1;lkstepended:=false;end{:113};131:{115:}
...
lkstepended:=false;end{:115};132:{116:}
if not lkstepended then begin if charsonline>0 then writeln(stderr,' ');
...
if minnl<=nl+c then minnl:=nl+c+1;end;lkstepended:=false;end{:116};
133:{118:}begin ligkern[nl].b0:=0;ligkern[nl].b1:=getbyte;
...
showerrorcontext;end else nl:=nl+1;lkstepended:=true;end{:118};
134,135,136,137,139,140,141,145:{117:}begin ligkern[nl].b0:=0;
...
150:{121:}begin c:=getcharcode;categoryremainders[c]:=nl;
if maxivaluecategory<c then maxivaluecategory:=c;
if minnl<=nl then minnl:=nl+1;lkstepended:=false;end{:121};151:{122:}
...
152:{123:}begin ligkern[nl].b0:=256;ligkern[nl].b1:=getbyte;
...
153:{124:}begin ligkern[nl].b0:=256;ligkern[nl].b1:=getbyte;
...
showerrorcontext;end else nl:=nl+1;lkstepended:=true;end{:124};
154:{125:}begin ligkern[nl].b0:=256;ligkern[nl].b1:=getbyte;
...
showerrorcontext;end else nl:=nl+1;lkstepended:=true;end{:125};end;
finishtheproperty;end;end{:111};end;procedure readcharacterproperty;
begin{137:}begin getname;
...
if curchar=40 then{139:}begin getname;
...
end;finishtheproperty;end;end{:139}
else if curchar=41 then skiptoendofitem else junkerror;end;ne:=ne+1;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end;end{:138};
...
end{:137};end;procedure readcharinfo;begin{131:}
begin if not tablesread then begin{286:}begin{283:}begin nwi:=0;
for iarray:=0 to nki do begin npi[iarray]:=npi[iarray]+1;
nwi:=nwi+npi[iarray];end;nki:=nki+1;end{:283};{271:}begin nwf:=0;
for farray:=0 to nkf do begin npf[farray]:=npf[farray]+1;
nwf:=nwf+npf[farray];end;nkf:=nkf+1;end{:271};{259:}begin nwm:=0;
...
nwg:=nwg+4*npg[garray];end;nkg:=nkg+1;end{:235};{247:}begin nwp:=0;
for parray:=0 to nkp do begin npp[parray]:=npp[parray]+1;
nwp:=nwp+npp[parray];end;nkp:=nkp+1;end{:247};end{:286};
tablesread:=true;end;c:=getcharcode;if verbose then{146:}
begin if charsonline>=8 then begin writeln(stderr,' ');charsonline:=1;
end else begin if charsonline>0 then write(stderr,' ');
charsonline:=charsonline+1;end;printnumber(c,16);end{:146};
while level=1 do begin while curchar=32 do getnext;
...
skiptoendofitem else junkerror;end;
if charwd[c]=0 then charwd[c]:=sortin(1,0);begin loc:=loc-1;
level:=level+1;curchar:=41;end;end{:131};end;procedure readinput;
var c:bytetype;begin{93:}curchar:=32;repeat while curchar=32 do getnext;
...
showerrorcontext;end;skiptoendofitem;end else begin{96:}
case curcode of 1:begin checksumspecified:=true;readfourbytes(0);end;
2:{99:}begin nextd:=getfix;
...
end else designsize:=nextd;end{:99};3:{100:}begin nextd:=getfix;
...
showerrorcontext;end else designunits:=nextd;end{:100};4:readBCPL(8,40);
...
headerbytes[71]:=c end;7:{101:}begin while curchar=32 do getnext;
...
headerptr:=headerptr+1;end;readfourbytes(4*c);end;end{:102};9:{103:}
...
param[c]:=getfix;finishtheproperty;end;end;end{:104}
else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end{:103};
...
end else vtitlelength:=vfptr-vtitlestart;end;13:{105:}
begin fontnumber[fontptr]:=getinteger;curfont:=0;
while fontnumber[fontptr]<>fontnumber[curfont]do curfont:=curfont+1;
if curfont=fontptr then if fontptr<xmaxfont then{106:}
...
fontat[curfont]:=1048576;fontdsize[curfont]:=10485760;end{:106}
...
while curchar=32 do getnext;if curchar=40 then{107:}begin getname;
...
showerrorcontext;end;skiptoendofitem;
end else begin case curcode of 200:{108:}
...
end else fnamelength[curfont]:=vfptr-fnamestart[curfont];end{:108};
201:{109:}begin fareastart[curfont]:=vfptr;copytoendofitem;
...
end else farealength[curfont]:=vfptr-fareastart[curfont];end{:109};
...
204:fontdsize[curfont]:=getfix;end;finishtheproperty;end;end{:107}
else if curchar=41 then skiptoendofitem else junkerror;end;
begin loc:=loc-1;level:=level+1;curchar:=41;end;end{:105};
14:readcharinfo;17:{210:}begin ofmlevel:=getinteger;
...
end;skiptoendofitem;end;ofmlevel:=1;end;end{:210};15:{211:}
...
showerrorcontext;end;skiptoendofitem;end;fontdir:=0;end;end{:211};
16:{212:}begin fontdir:=-1;repeat getnext;until curchar<>32;
case curchar of 84:begin getnext;
...
showerrorcontext;end;skiptoendofitem;end;fontdir:=8;end;end{:212};
...
23:readfontivaluelist;end{:96};finishtheproperty;end;end{:95}
...
end else if not inputhasended then junkerror;until inputhasended{:93};
end;procedure corrandcheck;var c:xchartype;hh:0..hashsize;
ligptr:0..maxligsteps;g:bytetype;begin{162:}if nl>0 then{168:}
...
div 256*256+128;end{:168};sevenunsafe:=false;
for c:=0 to maxchar do if charwd[c]<>0 then{163:}case chartag[c]of 0:;
1:{172:}begin ligptr:=charremainder[c];
...
[ligptr].b0;until ligptr>=nl;end;end{:172};2:begin g:=charremainder[c];
if(g>=128)and(c<128)then sevenunsafe:=true;
if charwd[g]=0 then begin charwd[g]:=sortin(1,0);
write(stderr,'The character NEXTLARGER than',' ');printnumber(c,16);
writeln(stderr,' had no CHARACTER spec.');end;end;3:{164:}
...
writeln(stderr,' had no CHARACTER spec.');end;end;end{:164};end{:163};
if charremainder[xmaxchar]<xmaxlabel then begin c:=xmaxchar;{172:}
...
writeln(stderr,' had no CHARACTER spec.');end;end;end;
if ligkern[ligptr].b0>=128 then ligptr:=nl else ligptr:=ligptr+1+ligkern
[ligptr].b0;until ligptr>=nl;end;end{:172};end;
if sevenbitsafeflag and sevenunsafe then writeln(stderr,
'The font is not really seven-bit-safe!');{177:}
...
charremainder[xmaxchar]:=xmaxlabel;end{:177};{178:}
...
);printnumber(c,16);writeln(stderr,'!');end;end;end{:178};
finishextendedfont;for c:=0 to maxchar do{165:}
...
printnumber(c,16);writeln(stderr,'.');end;end{:165};{167:}
...
writeln(stderr,' units.');end;{:167}{:162}end;procedure vfoutput;
var c:chartype;curfont:xfonttype;k:integer;begin{203:}
...
for curfont:=0 to fontptr-1 do{204:}begin vfoutfntdef(curfont);
...
curfont]+k],vffile);
vcount:=vcount+12+farealength[curfont]+fnamelength[curfont];end{:204};
for c:=bc to ec do if charwd[c]>0 then{205:}begin x:=memory[charwd[c]];
if designunits<>1048576 then x:=round((x/designunits)*1048576.0);
...
]-1 do putbyte(vf[packetstart[c]+k],vffile);end{:205};
repeat putbyte(248,vffile);vcount:=vcount+1;until vcount mod 4=0{:203};
end;{:206}{207:}begin initialize;nameenter;readinput;
if verbose then writeln(stderr,'.');corrandcheck;{180:}
computesubfilesizes;outputsubfilesizes;{186:}
if not checksumspecified then{187:}begin curbytes.b0:=bc;
...
headerbytes[2]:=curbytes.b2;headerbytes[3]:=curbytes.b3;end{:187};
...
for j:=0 to headerptr-1 do putbyte(headerbytes[j],tfmfile);{:186};
outputnewinformationofm;outputcharacterinfo;{192:}
for q:=1 to 4 do begin putbyte(0,tfmfile);putbyte(0,tfmfile);
putbyte(0,tfmfile);putbyte(0,tfmfile);p:=link[q];
while p>0 do begin outscaled(memory[p]);p:=link[p];end;end;{:192};{197:}
...
if nk>0 then for krnptr:=0 to nk-1 do outscaled(kern[krnptr])end{:197};
{198:}
...
putbyte((exten[c].b3)mod 256,tfmfile);end;end;{:198};{199:}
for parptr:=1 to np do begin if parptr=1 then{200:}
...
putbyte(param[1]mod 256,tfmfile);end{:200}else outscaled(param[parptr]);
end{:199}{:180};vfoutput;9999:if not perfect then uexit(1);end.{:207}
