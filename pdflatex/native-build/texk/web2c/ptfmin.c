...
#include "mpconfig.h"
#line 4 "../../../texlive-source/texk/web2c/pmpostdir/ptfmin.ch"
...
#define read_triplekanji(A) {(A)= tfbyte; \
tfget;(A)= (A)*0400+tfbyte; \
...
boolean file_opened;
font_number n;
#line 13 "../../../texlive-source/texk/web2c/pmpostdir/ptfmin.ch"
...
int z;
int d;
#line 19 "../../../texlive-source/texk/web2c/pmpostdir/ptfmin.ch"
int h_and_d;
halfword ct;
halfword id;
#line 74 "ptfmin.w"
...
#line 109 "../../../texlive-source/texk/web2c/pmpostdir/ptfmin.ch"
...
/*7:*/
#line 56 "../../../texlive-source/texk/web2c/pmpostdir/ptfmin.ch"
...
tfget;read_two(nh);
tfget;read_two(nd);
#line 70 "../../../texlive-source/texk/web2c/pmpostdir/ptfmin.ch"
...
#line 79 "../../../texlive-source/texk/web2c/pmpostdir/ptfmin.ch"
mp->font_id[n]= id;
mp->font_nt[n]= nt;
...
#line 92 "../../../texlive-source/texk/web2c/pmpostdir/ptfmin.ch"
tf_ignore(4*(tfm_lh-2))

/*:9*/
#line 113 "ptfmin.w"

#line 28 "../../../texlive-source/texk/web2c/pmpostdir/ptfmin.ch"
/*10:*/
#line 94 "../../../texlive-source/texk/web2c/pmpostdir/ptfmin.ch"

ii= mp->ctype_base[n]+nt;
i= mp->ctype_base[n];
while(i<ii){
tfget;read_triplekanji(ct);
...
/*:11*/
#line 30 "../../../texlive-source/texk/web2c/pmpostdir/ptfmin.ch"
