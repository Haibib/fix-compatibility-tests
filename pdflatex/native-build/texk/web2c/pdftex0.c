...
convtoks ( void ) 
{
  ...
  case 19 : 
    {
      booltemp = scankeyword ( 900 ) ;
      if ( scankeyword ( 901 ) ) 
      curval = 2 ;
      else if ( scankeyword ( 900 ) ) 
      curval = 1 ;
      else curval = 0 ;
      savescannerstatus = scannerstatus ;
      savewarningindex = warningindex ;
...
openlogfile ( void ) 
{
  ...
  logopened = true ;
  {
    ...
    fprintf ( logfile , "%s%s%s",  "This is pdfTeX, Version 3.141592653" , "-2.6" ,     "-1.40.29" ) ;
    else
    fprintf ( logfile , "%s%s%s",  "This is pdfTeX, Version 3.141592653" , "-2.6" ,     "-1.40.29" ) ;
...
zoutwhat ( halfword p ) 
{
  ...
  case 2 : 
	...
	else if ( j < 16 ) 
	{
	  ...
	  aopenout ( writefile [j ]) ) promptfilename ( 1944 , 956 ) ;
	  writeopen [j ]= true ;
...
zdvishipout ( halfword p ) 
{
  ...
  synctexsheet ( eqtb [29294 ].cint ) ;
  {
    ...
    if ( outputfilename == 0 ) 
    {
      ...
      openlogfile () ;
      packjobname ( 960 ) ;
      while ( ! bopenout ( dvifile ) ) promptfilename ( 961 , 960 ) ;
...
checkpdfversion ( void ) 
{
  ...
  if ( ! pdfversionwritten ) 
  {
    ...
    pdfosenable = true ;
      ...
      {
	pdfwarning ( 1025 , 1026 , true , true ) ;
	fixedpdfobjcompresslevel = 0 ;
      } 
      pdfosenable = false ;
    } 
...
ensurepdfopen ( void ) 
{
  ...
  while ( ! bopenout ( pdffile ) ) promptfilename ( 961 , 1030 ) ;
...
zliteral ( strnumber s , integer literalmode , boolean warn ) 
{
  ...
  if ( literalmode == 3 ) 
  {
    if ( ! ( strinstr ( s , 1069 , 0 ) || strinstr ( s , 1070 , 0 ) ) ) 
    {
      if ( warn && ! ( strinstr ( s , 1071 , 0 ) || strinstr ( s , 1072 , 0 ) 
    ...
    if ( strinstr ( s , 1075 , ( strstart [1070 ]- strstart [1069 ]) ) ) 
    {
      j = j + ( strstart [1076 ]- strstart [1075 ]) ;
      literalmode = 2 ;
    } 
    else if ( strinstr ( s , 1076 , ( strstart [1070 ]- strstart [1069 ]) 
    ) ) 
    {
...
zadjustinterwordglue ( halfword p , halfword g ) 
{
  ...
  {
    pdfwarning ( 1090 , 1091 , true , true ) ;
    return ;
  } 
  c = 256 ;
  if ( ( p >= himemmin ) ) 
...
ztfmlookup ( strnumber s , scaled fs ) 
{
  ...
  if ( fs != 0 ) 
  {
    ...
    do 
      if ( ( fontarea [k ]!= 1089 ) && streqstr ( fontname [k ], s ) && ( 
      fontsize [k ]== fs ) ) 
      {
	flushstr ( s ) ;
	Result = k ;
...
zletterspacefont ( halfword u , internalfontnumber f , integer e ) 
{
  ...
  pdfwarning ( 1106 , 1107 , true , true ) ;
  {register integer for_end; i = 0 ;for_end = nw - 1 ; if ( i <= for_end) do 
...
zdovf ( internalfontnumber f ) 
{
  ...
  return ;
  stacklevel = 0 ;
  packfilename ( fontname [f ], 345 , 1113 ) ;
  if ( ! vfbopenin ( vffile ) ) 
  return ;
  if ( vfbyte () != 247 ) 
  ...
  while ( cmd <= 242 ) {
      ...
      case 142 : 
	{
	  ...
	  if ( cmd == 141 ) {
	    ...
	    overflow ( 1136 , vfstacksize ) ;
	    else incr ( stacklevel ) ;
	  } 
	  else if ( stacklevel == 0 ) 
	  vferror ( fontname [f ], 1137 ) ;
...
zwriteaction ( halfword p ) 
{
  ...
  if ( mem [p + 3 ].hh .v.RH != -268435455L ) 
  {
    ...
    if ( mem [p + 1 ].hh .v.LH == -268435455L ) 
    pdfindirect ( 1958 , getobj ( 6 , mem [p + 3 ].hh .v.RH , ( mem [p ]
    .hh.b1 / 2 ) % 2 ) ) ;
    else {
...
zdodest ( halfword p , halfword parentbox , scaled x , scaled y ) 
{
  ...
  {
    warndestdup ( mem [p + 5 ].hh .v.RH , mem [p + 5 ].hh.b1 , 1875 , 1876 
    ) ;
    return ;
  } 
  objtab [k ].int4 = p ;
...
zpdfshipout ( halfword p , boolean shippingpage ) 
{
  ...
  if ( ! shippingpage ) 
  {
    ...
    pdfindirectln ( 1156 , pdflastresources ) ;
  } 
  pdfbeginstream () ;
  if ( shippingpage ) 
  {
  ...
  if ( shippingpage ) 
  {
    ...
    pdfindirectln ( 1175 , pdflastpages ) ;
...
pdfprintinfo ( void ) 
{
  ...
  if ( pdfinfotoks != -268435455L ) 
  {
    ...
    creatorgiven = substrofstr ( 1230 , s ) ;
    producergiven = substrofstr ( 1231 , s ) ;
    creationdategiven = substrofstr ( 1232 , s ) ;
    moddategiven = substrofstr ( 1233 , s ) ;
    trappedgiven = substrofstr ( 1234 , s ) ;
  } 
  if ( ! producergiven ) 
  {
    pdfprint ( 1240 ) ;
  ...
  if ( eqtb [29374 ].cint % 2 == 0 ) 
  {
    ...
    pdfstrentryln ( 1238 , pdftexbanner ) ;
    else pdfstrentryln ( 1239 , pdftexbanner ) ;
  } 
  pdfenddict () ;
} 
void 
...
zcheckpdfoutput ( strnumber s , boolean iserror ) 
{
  ...
  if ( eqtb [29342 ].cint <= 0 ) 
  {
    if ( iserror ) 
    pdferror ( s , 1793 ) ;
    else pdfwarning ( s , 1794 , true , true ) ;
  } 
} 
void 
scanpdfexttoks ( void ) 
...
zscaleimage ( integer n ) 
{
  ...
  if ( ( xr > 65535L ) || ( yr > 65535L ) ) 
  {
    xr = 0 ;
    yr = 0 ;
    pdfwarning ( 1792 , 1823 , true , true ) ;
  } 
  ...
  yr ) ) 
  {
    xr = 0 ;
    yr = 0 ;
    pdfwarning ( 1792 , 1825 , true , true ) ;
  } 
  if ( ispdfimage ( image ) ) 
  {
    w = x ;
...
scanimage ( void ) 
{
  ...
  {
    pdfwarning ( 1833 , 1834 , true , true ) ;
  ...
  {
    pdfwarning ( 1833 , 1835 , true , true ) ;
  ...
  if ( eqtb [29353 ].cint > 0 ) 
  {
    if ( warnpdfpagebox ) 
    {
      pdfwarning ( 1833 , 1836 , true , true ) ;
      warnpdfpagebox = false ;
    } 
...
zpdffixthread ( integer thread ) 
{
  pdffixthread_regmem 
  halfword a  ;
  pdfwarning ( 1841 , 1902 , true , false ) ;
  if ( objtab [thread ].int0 < 0 ) 
  {
    print ( 1207 ) ;
...
doextension ( void ) 
{
  ...
  case 9 : 
	...
	if ( scankeyword ( 1814 ) ) 
	{
	  ...
	  if ( ( k <= 0 ) || ( k > objptr ) || ( objtab [k ].int4 != 0 ) ) 
	  {
	    pdfwarning ( 1812 , 1815 , true , true ) ;
	    pdfretval = -1 ;
	    k = -1 ;
	  } 
	} 
  ...
  if ( fixedpdfoutput > 0 ) 
  {
	...
	if ( fixedpdfdraftmode == 0 ) 
	{
	  ...
	  while ( objtab [k ].int4 == 0 ) {
	    ...
	    pdfwarning ( 1206 , 1213 , true , false ) ;
	    printint ( objtab [k ].int0 ) ;
	    print ( 1214 ) ;
	    println () ;
	    println () ;
	  ...
	  for_end) do 
		...
		pdfmarkchar ( i , j ) ;
	      ...
	      pdffontattr [i ], pdffontattr [k ]) ) 
	      {
		pdfwarning ( 1215 , 1216 , true , false ) ;
	  ...
	  if ( pdffirstoutline != 0 ) 
	  {
	    ...
	    pdfindirectln ( 1199 , pdffirstoutline ) ;
	    pdfindirectln ( 1200 , pdflastoutline ) ;
	    pdfintentryln ( 1201 , k ) ;
	    pdfenddict () ;
	    k = headtab [4 ];
	    while ( k != 0 ) {
		...
		pdflastoutline = k ;
	      ...
	      pdfbegindict ( k , 1 ) ;
	      pdfindirectln ( 1202 , pdfmem [objtab [k ].int4 ]) ;
	      pdfindirectln ( 65 , pdfmem [objtab [k ].int4 + 6 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 1 ]!= 0 ) 
	      pdfindirectln ( 1175 , pdfmem [objtab [k ].int4 + 1 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 2 ]!= 0 ) 
	      pdfindirectln ( 1203 , pdfmem [objtab [k ].int4 + 2 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 3 ]!= 0 ) 
	      pdfindirectln ( 1204 , pdfmem [objtab [k ].int4 + 3 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 4 ]!= 0 ) 
	      pdfindirectln ( 1199 , pdfmem [objtab [k ].int4 + 4 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 5 ]!= 0 ) 
	      pdfindirectln ( 1200 , pdfmem [objtab [k ].int4 + 5 ]) ;
	      if ( objtab [k ].int0 != 0 ) 
	      pdfintentryln ( 1201 , objtab [k ].int0 ) ;
	  ...
	  if ( threads != 0 ) 
	  pdfindirectln ( 1226 , threads ) ;
	  if ( outlines != 0 ) 
	  pdfindirectln ( 1227 , outlines ) ;
	  if ( namestree != 0 ) 
	  pdfindirectln ( 1228 , namestree ) ;
	  ...
	  if ( pdfcatalogopenaction != 0 ) 
	  pdfindirectln ( 1229 , pdfcatalogopenaction ) ;
	  pdfenddict () ;
	  ...
	  if ( ! pdfosenable ) 
	  {
	    ...
	    pdfprint ( 1254 ) ;
	    pdfintentryln ( 1248 , sysobjptr + 1 ) ;
	    pdfindirectln ( 1251 , root ) ;
	    if ( eqtb [29376 ].cint == 0 ) 
	    pdfindirectln ( 1252 , sysobjptr ) ;
	    if ( pdftrailertoks != -268435455L ) 
	    {
	      pdfprinttoksln ( pdftrailertoks ) ;
	      {
	...
	if ( fixedpdfdraftmode == 0 ) 
	bclose ( pdffile ) ;
	else pdfwarning ( 0 , 1205 , true , true ) ;
      } 
      if ( logopened ) 
      {
	putc ('\n',  logfile );
