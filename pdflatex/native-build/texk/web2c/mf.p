...
stopatspace:=true;haltingonerrorp:=false;{:1215}end;
...
{790:}begin write(logfile,'This is METAFONT, Version 2.71828182');
slowprint(baseident);print(755);printint(sysday);printchar(32);
...
inputstack[inputptr]:=curinput;printnl(753);
...
dumpthings(baseengine[0],x);libcfree(baseengine);dumpint(118588231);
...
libcfree(baseengine);undumpint(x);if x<>118588231 then begin;
...
{:55}{61:}write(stdout,'This is METAFONT, Version 2.71828182');
