...
0,
0x2f00,
0x3000+(FF_ffi_sizeof),
0x3000+(FF_ffi_alignof),
0x3000+(FF_ffi_offsetof),
0x3100,
0x3200,
0x3300,
0x3400,
...
0,
0,
0x3700+(GCROOT_IO_OUTPUT),
0x3800+(GCROOT_IO_OUTPUT),
0,
0,
0,
0,
...
0x4300+(1),
0x4500,
0x4600+(IRCALL_lj_buf_putstr_reverse),
0x4600+(IRCALL_lj_buf_putstr_lower),
0x4600+(IRCALL_lj_buf_putstr_upper),
0,
0x4700,
0,
0,
