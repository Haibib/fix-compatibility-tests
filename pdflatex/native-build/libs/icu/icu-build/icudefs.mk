...
CFLAGS = -O2 -g0 -std=c11 $(THREADSCFLAGS) -Qunused-arguments -Wno-parentheses-equality
# CXXFLAGS is for C++ only flags
CXXFLAGS = -O2 -g0 -std=c++17 $(THREADSCXXFLAGS) -Qunused-arguments -Wno-parentheses-equality
# CPPFLAGS is for C Pre-Processor flags
CPPFLAGS =  -ffunction-sections -fdata-sections $(THREADSCPPFLAGS)  -DU_HAVE_ELF_H=1 -DU_ENABLE_DYLOAD=0 
